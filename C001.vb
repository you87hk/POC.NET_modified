...
Friend Class frmC001
    Inherits System.Windows.Forms.Form

    Private wlSalesmanID As Integer
    Private wlCusTyp As Integer
    ...
    Private Sub cboCusMLCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusMLCode.DropDown
        Dim wsSQL As String
        ...
        Call Ini_Combo(2, wsSQL, VB6.PixelsToTwipsX(cboCusMLCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboCusMLCode.Top) + VB6.PixelsToTwipsY(cboCusMLCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "C001", "TBLCUSML", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
    ...
    Private Sub cboCusMLCode_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusMLCode.Enter
        FocusMe(cboCusMLCode)
    End Sub

    Private Sub cboCusMLCode_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles cboCusMLCode.KeyPress
...
EventExitSub:
    ...
    Private Sub cboCusMLCode_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusMLCode.Leave
        FocusMe(cboCusMLCode, True)
    End Sub


    Private Sub cboCusRgnCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusRgnCode.DropDown
        Dim wsSQL As String
        ...
        Call Ini_Combo(2, wsSQL, VB6.PixelsToTwipsX(cboCusRgnCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboCusRgnCode.Top) + VB6.PixelsToTwipsY(cboCusRgnCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "C001", "TBLCUSRGN", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
    ...
    Private Sub cboCusRgnCode_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusRgnCode.Enter
        FocusMe(cboCusRgnCode)
    End Sub


    Private Sub cboCusRgnCode_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles cboCusRgnCode.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
        Dim wsDesc As String
...
EventExitSub:
    ...
    Private Sub cboCusRgnCode_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusRgnCode.Leave
        FocusMe(cboCusRgnCode, True)
    End Sub

    Private Sub frmC001_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmC001_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
    ...
    Public Function LoadRecord() As Boolean
        ...
        Else
            ...
            Me.txtCusCreditLimit.Text = VB6.Format(To_Value(ReadRs(rsRcd, "CusCreditLimit")), gsAmtFmt)
            'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            Me.cboCusMLCode.Text = ReadRs(rsRcd, "CusMLCode")
            'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            Me.txtCusSpecDis.Text = VB6.Format(ReadRs(rsRcd, "CusSpecDis"), gsAmtFmt)
            'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
    ...
    Private Sub frmC001_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
...
cmdSave_Err:
    ...
    Private Sub txtCusCreditLimit_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtCusCreditLimit.Leave
        txtCusCreditLimit.Text = VB6.Format(txtCusCreditLimit.Text, gsAmtFmt)
        FocusMe(txtCusContactPerson, True)
    End Sub
    ...
    Private Sub txtCusSpecDis_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtCusSpecDis.Leave
        txtCusSpecDis.Text = VB6.Format(txtCusSpecDis.Text, gsAmtFmt)
    ...
    Private Sub OpenPromptForm()
        ...
        If Trim(frmShareSearch.Tag) <> "" And Trim(frmShareSearch.Tag) <> cboCusCode.Text Then
            cboCusCode.Text = Trim(frmShareSearch.Tag)
...
tblCommon_LostFocus_Err:
    ...
    Private Sub cboCusCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusCode.DropDown
        ...
        Call Ini_Combo(2, wsSQL, (VB6.PixelsToTwipsX(cboCusCode.Left)), VB6.PixelsToTwipsY(cboCusCode.Top) + VB6.PixelsToTwipsY(cboCusCode.Height), tblCommon, "C001", "TBLC", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
    ...
    Private Sub cboCusShipTerrCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusShipTerrCode.DropDown
        ...
        Call Ini_Combo(2, wsSQL, VB6.PixelsToTwipsX(cboCusShipTerrCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboCusShipTerrCode.Top) + VB6.PixelsToTwipsY(cboCusShipTerrCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "C001", "TBLTERR", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
    ...
    Private Sub cboCusShipTerrCode2_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusShipTerrCode2.DropDown
        ...
        wsSQL = "SELECT TerrCode, TerrDesc FROM MstTerritory WHERE TerrStatus = '1'"
        wsSQL = wsSQL & "ORDER BY TerrCode "
        Call Ini_Combo(2, wsSQL, VB6.PixelsToTwipsX(cboCusShipTerrCode2.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboCusShipTerrCode2.Top) + VB6.PixelsToTwipsY(cboCusShipTerrCode2.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "C001", "TBLTERR", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
    ...
    Private Sub cboCusPayCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusPayCode.DropDown
        ...
        Call Ini_Combo(3, wsSQL, VB6.PixelsToTwipsX(cboCusPayCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboCusPayCode.Top) + VB6.PixelsToTwipsY(cboCusPayCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "C001", "TBLPYT", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
    ...
    Private Sub cboCusCurr_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusCurr.DropDown
        ...
        Call Ini_Combo(1, wsSQL, VB6.PixelsToTwipsX(cboCusCurr.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboCusCurr.Top) + VB6.PixelsToTwipsY(cboCusCurr.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "C001", "TBLCUR", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
    ...
    Private Sub cboCusSaleCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusSaleCode.DropDown
        ...
        Call Ini_Combo(2, wsSQL, VB6.PixelsToTwipsX(cboCusSaleCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboCusSaleCode.Top) + VB6.PixelsToTwipsY(cboCusSaleCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "C001", "TBLSLM", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
