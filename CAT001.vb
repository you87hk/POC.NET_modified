...
Friend Class frmCAT001
	...
	Private Const wsKeyType As String = "MstCategory"
	Private wsUsrId As String
	Private wsTrnCd As String
	
	Private Sub cboCatCode_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCatCode.Leave
		FocusMe(cboCatCode, True)
	End Sub
	
	Private Sub frmCAT001_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmCAT001_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	'UPGRADE_WARNING: Event frmCAT001.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmCAT001_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Public Function LoadRecord() As Boolean
		...
		wsSQL = wsSQL & "WHERE (((MstCategory.CatCode)='" & cboCatCode.Text & "' "
		...
		Else
			...
			Me.cboCatCode.Text = ReadRs(rsRcd, "CatCode")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.txtCatDesc.Text = ReadRs(rsRcd, "CatDesc")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.lblDspCatLastUpd.Text = ReadRs(rsRcd, "CatLastUpd")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.lblDspCatLastUpdDate.Text = ReadRs(rsRcd, "CatLastUpdDate")
	...
	Private Sub frmCAT001_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		...
		'UPGRADE_NOTE: Object frmCAT001 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
	End Sub
		...
		Select Case wiAction
			...
			Case CorRec, DelRec
				...
				If LoadRecord() = False Then
					...
					Exit Sub
				Else
					If RowLock(wsConnTime, wsKeyType, cboCatCode.Text, wsFormID, wsUsrId) = False Then
	...
	Private Function cmdSave() As Boolean
		...
		If wiAction <> AddRec Then
			If ReadOnlyMode(wsConnTime, wsKeyType, cboCatCode.Text, wsFormID) Then
...
cmdSave_Err: 
	...
	Private Sub OpenPromptForm()
		...
		'UPGRADE_ISSUE: Form property frmCAT001.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
        Me.Cursor = System.Windows.Forms.Cursors.Default ' vbNormal
		If Trim(frmShareSearch.Tag) <> "" And Trim(frmShareSearch.Tag) <> cboCatCode.Text Then
			cboCatCode.Text = Trim(frmShareSearch.Tag)
    ...
    Private Sub txtCatCode_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtCatCode.Leave
        FocusMe(txtCatCode, True)
    End Sub

    Private Sub txtCatDesc_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtCatDesc.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
    ...
    Private Sub txtCatCode_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtCatCode.Enter
        FocusMe(txtCatCode)
    End Sub

    Private Sub txtCatDesc_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtCatDesc.Enter
        FocusMe(txtCatDesc)
    End Sub
    ...
    Private Sub cboCatCode_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles cboCatCode.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
	...
	Private Sub cboCatCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCatCode.DropDown
		...
		wsSQL = wsSQL & " AND CatCode LIKE '%" & IIf(cboCatCode.SelectionLength > 0, "", Set_Quote(cboCatCode.Text)) & "%' "
		wsSQL = wsSQL & "ORDER BY CatCode "
		Call Ini_Combo(2, wsSQL, (VB6.PixelsToTwipsX(cboCatCode.Left)), VB6.PixelsToTwipsY(cboCatCode.Top) + VB6.PixelsToTwipsY(cboCatCode.Height), tblCommon, "CAT001", "TBLCAT", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
	...
	Private Sub cboCatCode_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCatCode.Enter
		FocusMe(cboCatCode)
	End Sub
	
	
	Private Sub txtCatDesc_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtCatDesc.Leave
	...
	Private Function Chk_KeyExist() As Boolean
		...
		wsSQL = "SELECT CatStatus FROM MstCategory WHERE CatCode = '" & Set_Quote(txtCatCode.Text) & "'"
		rsRcd.Open(wsSQL, cnCon, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockOptimistic)
	...
	Private Sub Ini_Caption()
		...
		lblCatCode.Text = Get_Caption(waScrItm, "CATCODE")
		lblCatDesc.Text = Get_Caption(waScrItm, "CATDESC")
		lblCatLastUpd.Text = Get_Caption(waScrItm, "CATLASTUPD")
		lblCatLastUpdDate.Text = Get_Caption(waScrItm, "CATLASTUPDDATE")
