...
Friend Class frmM001
	...
	Private Const wsKeyType As String = "MstMethod"
	Private wsUsrId As String
	Private wsTrnCd As String
	
	Private Sub cboMethodCode_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboMethodCode.Leave
		FocusMe(cboMethodCode, True)
	End Sub
	
	Private Sub frmM001_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmM001_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	'UPGRADE_WARNING: Event frmM001.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmM001_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Public Function LoadRecord() As Boolean
		...
		wsSQL = wsSQL & "WHERE (((MstMethod.MethodCode)='" & Set_Quote(cboMethodCode.Text) & "') "
		...
		Else
			...
			Me.cboMethodCode.Text = ReadRs(rsRcd, "MethodCode")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.txtMethodDesc.Text = ReadRs(rsRcd, "MethodDesc")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.lblDspMethodLastUpd.Text = ReadRs(rsRcd, "MethodLastUpd")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.lblDspMethodLastUpdDate.Text = ReadRs(rsRcd, "MethodLastUpdDate")
	...
	Private Sub frmM001_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		...
		'UPGRADE_NOTE: Object frmM001 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
	End Sub
		...
		Select Case wiAction
			...
			Case CorRec, DelRec
				...
				If LoadRecord() = False Then
					...
					Exit Sub
				Else
					If RowLock(wsConnTime, wsKeyType, cboMethodCode.Text, wsFormID, wsUsrId) = False Then
	...
	Private Function cmdSave() As Boolean
		...
		If wiAction <> AddRec Then
			If ReadOnlyMode(wsConnTime, wsKeyType, cboMethodCode.Text, wsFormID) Then
		...
		Call SetSPPara(adcmdSave, 2, IIf(wiAction = AddRec, txtMethodCode.Text, cboMethodCode.Text))
...
cmdSave_Err: 
	...
	Private Sub OpenPromptForm()
		...
		'UPGRADE_ISSUE: Form property frmM001.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
        Me.Cursor = System.Windows.Forms.Cursors.Default ' vbNormal
		If Trim(frmShareSearch.Tag) <> "" And Trim(frmShareSearch.Tag) <> cboMethodCode.Text Then
			cboMethodCode.Text = Trim(frmShareSearch.Tag)
			System.Windows.Forms.SendKeys.Send("{ENTER}")
		End If
		frmShareSearch.Close()
	End Sub
	
	Private Sub txtMethodCode_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtMethodCode.KeyPress
	...
	Private Sub txtMethodCode_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtMethodCode.Leave
		FocusMe(txtMethodCode, True)
	End Sub
	
	Private Sub txtMethodDesc_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtMethodDesc.KeyPress
		Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
	...
	Private Sub txtMethodCode_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtMethodCode.Enter
		FocusMe(txtMethodCode)
	End Sub
	
	Private Sub txtMethodDesc_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtMethodDesc.Enter
	...
	Private Sub cboMethodCode_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles cboMethodCode.KeyPress
		Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
	...
	Private Sub cboMethodCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboMethodCode.DropDown
		
		Dim wsSQL As String
		
		Me.Cursor = System.Windows.Forms.Cursors.WaitCursor
		
		wcCombo = cboMethodCode
		
		wsSQL = "SELECT MethodCode, MethodDesc FROM MstMethod WHERE MethodStatus = '1'"
		wsSQL = wsSQL & " AND MethodCode LIKE '%" & IIf(cboMethodCode.SelectionLength > 0, "", Set_Quote(cboMethodCode.Text)) & "%' "
		
		wsSQL = wsSQL & "ORDER BY MethodCode "
		Call Ini_Combo(2, wsSQL, (VB6.PixelsToTwipsX(cboMethodCode.Left)), VB6.PixelsToTwipsY(cboMethodCode.Top) + VB6.PixelsToTwipsY(cboMethodCode.Height), tblCommon, "M001", "TBLM", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
	...
	Private Sub cboMethodCode_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboMethodCode.Enter
		FocusMe(cboMethodCode)
	End Sub
	
	
	Private Sub txtMethodDesc_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtMethodDesc.Leave
	...
	Private Function Chk_KeyExist() As Boolean
		...
		wsSQL = "SELECT MethodStatus FROM MstMethod WHERE MethodCode = '" & Set_Quote(txtMethodCode.Text) & "'"
		rsRcd.Open(wsSQL, cnCon, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockOptimistic)
	...
	Private Sub Ini_Caption()
		...
		lblMethodCode.Text = Get_Caption(waScrItm, "METHODCODE")
		lblMethodDesc.Text = Get_Caption(waScrItm, "METHODDESC")
		lblMethodLastUpd.Text = Get_Caption(waScrItm, "METHODLASTUPD")
		lblMethodLastUpdDate.Text = Get_Caption(waScrItm, "METHODLASTUPDDATE")
