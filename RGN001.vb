...
Friend Class frmRGN001
	...
	Private Const wsKeyType As String = "MstRegion"
	Private wsUsrId As String
	Private wsTrnCd As String
	
	Private Sub cboRgnCode_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboRgnCode.Leave
		FocusMe(cboRgnCode, True)
	End Sub
	
	Private Sub frmRGN001_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmRGN001_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	'UPGRADE_WARNING: Event frmRGN001.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmRGN001_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Public Function LoadRecord() As Boolean
		...
		wsSQL = wsSQL & "WHERE (((MstRegion.RgnCode)='" & Set_Quote(cboRgnCode.Text) & "') "
		...
		Else
			...
			Me.cboRgnCode.Text = ReadRs(rsRcd, "RgnCode")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.txtRgnDesc.Text = ReadRs(rsRcd, "RgnDesc")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.lblDspRgnLastUpd.Text = ReadRs(rsRcd, "RgnLastUpd")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.lblDspRgnLastUpdDate.Text = ReadRs(rsRcd, "RgnLastUpdDate")
	...
	Private Sub frmRGN001_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		...
		'UPGRADE_NOTE: Object frmRGN001 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
	End Sub
		...
		Select Case wiAction
			...
			Case CorRec, DelRec
				...
				If LoadRecord() = False Then
					...
					Exit Sub
				Else
					If RowLock(wsConnTime, wsKeyType, cboRgnCode.Text, wsFormID, wsUsrId) = False Then
	...
	Private Function cmdSave() As Boolean
		...
		If wiAction <> AddRec Then
			If ReadOnlyMode(wsConnTime, wsKeyType, cboRgnCode.Text, wsFormID) Then
		...
		Call SetSPPara(adcmdSave, 2, IIf(wiAction = AddRec, txtRgnCode.Text, cboRgnCode.Text))
...
cmdSave_Err: 
	...
	Private Sub OpenPromptForm()
		...
		'UPGRADE_ISSUE: Form property frmRGN001.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
        Me.Cursor = System.Windows.Forms.Cursors.Default ' vbNormal
		If Trim(frmShareSearch.Tag) <> "" And Trim(frmShareSearch.Tag) <> cboRgnCode.Text Then
			cboRgnCode.Text = Trim(frmShareSearch.Tag)
			System.Windows.Forms.SendKeys.Send("{ENTER}")
		End If
		frmShareSearch.Close()
	End Sub
	
	Private Sub txtRgnCode_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtRgnCode.KeyPress
	...
	Private Sub txtRgnCode_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtRgnCode.Leave
		FocusMe(txtRgnCode, True)
	End Sub
	
	Private Sub txtRgnDesc_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtRgnDesc.KeyPress
		Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
	...
	Private Sub txtRgnCode_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtRgnCode.Enter
		FocusMe(txtRgnCode)
	End Sub
	
	Private Sub txtRgnDesc_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtRgnDesc.Enter
		FocusMe(txtRgnDesc)
	End Sub
	...
	Private Sub cboRgnCode_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles cboRgnCode.KeyPress
		Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
	...
	Private Sub cboRgnCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboRgnCode.DropDown
		Dim wsSQL As String
		...
		wsSQL = wsSQL & " AND RgnCode LIKE '%" & IIf(cboRgnCode.SelectionLength > 0, "", Set_Quote(cboRgnCode.Text)) & "%' "
		wsSQL = wsSQL & "ORDER BY RgnCode "
		Call Ini_Combo(2, wsSQL, (VB6.PixelsToTwipsX(cboRgnCode.Left)), VB6.PixelsToTwipsY(cboRgnCode.Top) + VB6.PixelsToTwipsY(cboRgnCode.Height), tblCommon, "RGN001", "TBLRGN", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
	...
	Private Sub cboRgnCode_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboRgnCode.Enter
		FocusMe(cboRgnCode)
	End Sub
	
	Private Sub txtRgnDesc_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtRgnDesc.Leave
	...
	Private Function Chk_KeyExist() As Boolean
		...
		wsSQL = "SELECT RgnStatus FROM MstRegion WHERE RgnCode = '" & Set_Quote(txtRgnCode.Text) & "'"
		rsRcd.Open(wsSQL, cnCon, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockOptimistic)
	...
	Private Sub Ini_Caption()
		...
		lblRgnCode.Text = Get_Caption(waScrItm, "RGNCODE")
		lblRgnDesc.Text = Get_Caption(waScrItm, "RGNDESC")
		lblRgnLastUpd.Text = Get_Caption(waScrItm, "RGNLASTUPD")
		lblRgnLastUpdDate.Text = Get_Caption(waScrItm, "RGNLASTUPDDATE")
