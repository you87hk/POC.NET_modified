...
Friend Class frmRmk001
	...
	Private Const wsKeyType As String = "MstRemark"
	...
	Private Sub frmRmk001_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmRmk001_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	'UPGRADE_WARNING: Event frmRmk001.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmRmk001_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
		'-- Resize, not maximum and minimax.
		If Me.WindowState = 0 Then
			Me.Height = VB6.TwipsToPixelsY(7215)
	...
	Public Function LoadRecord() As Boolean
		...
		Else
			...
			Me.cboRmkCode.Text = ReadRs(rsRcd, "RmkCode")
			
			For iCounter = 1 To 10
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(rsRcd, RmkDesc & iCounter). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				txtRmkDesc(iCounter).Text = ReadRs(rsRcd, "RmkDesc" & iCounter)
			Next iCounter
			
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.lblDspRmkLastUpd.Text = ReadRs(rsRcd, "RmkLastUpd")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.lblDspRmkLastUpdDate.Text = ReadRs(rsRcd, "RmkLastUpdDate")
	...
	Private Sub frmRmk001_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		...
		'UPGRADE_NOTE: Object frmRmk001 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
	End Sub
	...
	Private Sub Ini_Caption()
		...
		lblRmkDesc.Text = Get_Caption(waScrItm, "RMKDESC")
		lblRmkLastUpd.Text = Get_Caption(waScrItm, "RMKLASTUPD")
		lblRmkLastUpdDate.Text = Get_Caption(waScrItm, "RMKLASTUPDDATE")
...
Ini_Caption_Err: 
		...
		Select Case wiAction
			...
			Case CorRec, DelRec
				...
				If LoadRecord() = False Then
					...
					Exit Sub
				Else
					If RowLock(wsConnTime, wsKeyType, cboRmkCode.Text, wsFormID, wsUsrId) = False Then
	...
	Private Function cmdSave() As Boolean
		...
		If wiAction <> AddRec Then
			If ReadOnlyMode(wsConnTime, wsKeyType, cboRmkCode.Text, wsFormID) Then
...
cmdSave_Err: 
	...
	Private Sub OpenPromptForm()
		...
		'UPGRADE_ISSUE: Form property frmRmk001.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
        Me.Cursor = System.Windows.Forms.Cursors.Default ' vbNormal
		
		If Trim(frmShareSearch.Tag) <> "" And Trim(frmShareSearch.Tag) <> cboRmkCode.Text Then
			cboRmkCode.Text = Trim(frmShareSearch.Tag)
			cboRmkCode.Focus()
	...
	Private Sub txtRmkCode_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtRmkCode.Enter
		FocusMe(txtRmkCode)
	End Sub
	
	Private Sub txtRmkCode_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtRmkCode.KeyPress
	...
	Private Sub txtRmkCode_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtRmkCode.Leave
	...
	Private Sub cboRmkCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboRmkCode.DropDown
		...
		wsSQL = wsSQL & " AND RmkCode LIKE '%" & IIf(cboRmkCode.SelectionLength > 0, "", Set_Quote(cboRmkCode.Text)) & "%' "
		
		wsSQL = wsSQL & "ORDER BY RmkCode "
		Call Ini_Combo(1, wsSQL, (VB6.PixelsToTwipsX(cboRmkCode.Left)), VB6.PixelsToTwipsY(cboRmkCode.Top) + VB6.PixelsToTwipsY(cboRmkCode.Height), tblCommon, "RMK001", "TBLRMK", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
	...
	Private Function Chk_KeyExist() As Boolean
		...
		wsSQL = "SELECT RmkStatus FROM MstRemark WHERE RmkCode = '" & Set_Quote(txtRmkCode.Text) & "'"
		rsRcd.Open(wsSQL, cnCon, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockOptimistic)
	...
	Private Sub txtRmkDesc_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtRmkDesc.Enter
		Dim Index As Short = txtRmkDesc.GetIndex(eventSender)
		FocusMe(txtRmkDesc(Index))
	End Sub
	
	Private Sub txtRmkDesc_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtRmkDesc.KeyPress
		Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
		Dim Index As Short = txtRmkDesc.GetIndex(eventSender)
	...
	Private Sub txtRmkDesc_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtRmkDesc.Leave
		Dim Index As Short = txtRmkDesc.GetIndex(eventSender)
