...
Friend Class frmUOM001
	...
	Private Const wsKeyType As String = "MstUOM"
	Private wsUsrId As String
	Private wsTrnCd As String
	
	Private Sub cboUOMCode_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboUOMCode.Leave
		FocusMe(cboUOMCode, True)
	End Sub
	
	Private Sub frmUOM001_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmUOM001_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	'UPGRADE_WARNING: Event frmUOM001.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmUOM001_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Public Function LoadRecord() As Boolean
		...
		wsSQL = wsSQL & "WHERE (((MstUOM.UOMCode)='" & Set_Quote(cboUOMCode.Text) & "') "
		...
		Else
			...
			Me.cboUOMCode.Text = ReadRs(rsRcd, "UOMCode")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.txtUOMDesc.Text = ReadRs(rsRcd, "UOMDesc")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.lblDspUOMLastUpd.Text = ReadRs(rsRcd, "UOMLastUpd")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Me.lblDspUOMLastUpdDate.Text = ReadRs(rsRcd, "UOMLastUpdDate")
	...
	Private Sub frmUOM001_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		...
		'UPGRADE_NOTE: Object frmUOM001 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
	End Sub
		...
		Select Case wiAction
			...
			Case CorRec, DelRec
				...
				If LoadRecord() = False Then
					...
					Exit Sub
				Else
					If RowLock(wsConnTime, wsKeyType, cboUOMCode.Text, wsFormID, wsUsrId) = False Then
	...
	Private Function cmdSave() As Boolean
		...
		If wiAction <> AddRec Then
			If ReadOnlyMode(wsConnTime, wsKeyType, cboUOMCode.Text, wsFormID) Then
		...
		Call SetSPPara(adcmdSave, 2, IIf(wiAction = AddRec, txtUOMCode.Text, cboUOMCode.Text))
		...
		If wiAction = AddRec And Trim(wsNo) = "" Then
			gsMsg = "儲存失敗, 請檢查 Store Procedure - UOM001!"
			MsgBox(gsMsg, MsgBoxStyle.Information + MsgBoxStyle.OKOnly, gsTitle)
		Else
			If wiAction = DelRec Then
				gsMsg = "已成功刪除!"
...
cmdSave_Err: 
	...
	Private Sub OpenPromptForm()
		...
		'UPGRADE_ISSUE: Form property frmUOM001.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
        Me.Cursor = System.Windows.Forms.Cursors.Default ' vbNormal
		If Trim(frmShareSearch.Tag) <> "" And Trim(frmShareSearch.Tag) <> cboUOMCode.Text Then
			cboUOMCode.Text = Trim(frmShareSearch.Tag)
			System.Windows.Forms.SendKeys.Send("{ENTER}")
		End If
		frmShareSearch.Close()
	End Sub
	
	Private Sub txtUOMCode_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtUOMCode.KeyPress
    ...
    Private Sub txtUOMCode_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtUOMCode.Leave
        FocusMe(txtUOMCode, True)
    End Sub

    Private Sub txtUOMDesc_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtUOMDesc.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
    ...
    Private Sub txtUOMCode_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtUOMCode.Enter
        FocusMe(txtUOMCode)
    End Sub

    Private Sub txtUOMDesc_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtUOMDesc.Enter
        FocusMe(txtUOMDesc)
    End Sub
    ...
    Private Sub cboUOMCode_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles cboUOMCode.KeyPress
        Dim KeyAscii As Short = Asc(eventArgs.KeyChar)
	...
	Private Sub cboUOMCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboUOMCode.DropDown
		Dim wsSQL As String
		...
		wsSQL = wsSQL & " AND UomCode LIKE '%" & IIf(cboUOMCode.SelectionLength > 0, "", Set_Quote(cboUOMCode.Text)) & "%' "
		wsSQL = wsSQL & "ORDER BY UOMCode "
		Call Ini_Combo(2, wsSQL, (VB6.PixelsToTwipsX(cboUOMCode.Left)), VB6.PixelsToTwipsY(cboUOMCode.Top) + VB6.PixelsToTwipsY(cboUOMCode.Height), tblCommon, "UOM001", "TBLUOM", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
	...
	Private Sub cboUOMCode_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboUOMCode.Enter
		FocusMe(cboUOMCode)
	End Sub
	
	Private Sub txtUOMDesc_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles txtUOMDesc.Leave
	...
	Private Function Chk_KeyExist() As Boolean
		...
		wsSQL = "SELECT UOMStatus FROM MstUOM WHERE UOMCode = '" & Set_Quote(txtUOMCode.Text) & "'"
		rsRcd.Open(wsSQL, cnCon, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockOptimistic)
	...
	Private Sub Ini_Caption()
		...
		lblUOMDesc.Text = Get_Caption(waScrItm, "UOMDESC")
		lblUOMLastUpd.Text = Get_Caption(waScrItm, "UOMLASTUPD")
		lblUOMLastUpdDate.Text = Get_Caption(waScrItm, "UOMLASTUPDDATE")
