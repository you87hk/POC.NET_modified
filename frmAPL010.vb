...
Friend Class frmAPL010
	...
	Private Sub cmdOK()
		...
		wsSelection(3) = lblUsrFr.Text & " " & Set_Quote(cboUsrFr.Text) & " " & lblUsrTo.Text & " " & Set_Quote(cboUsrTo.Text)
		wsSelection(4) = lblUpdFr.Text & " " & medUpdFr.Text & " " & lblUpdTo.Text & " " & medUpdTo.Text
		
		'Create Stored Procedure String
		wsDteTim = CStr(Now)
		wsSQL = "EXEC usp_RPTAPL010 '" & Set_Quote(gsUserID) & "', "
		...
		NewfrmPrint.ReportID = "APL010"
		NewfrmPrint.RptTitle = Me.Text
		NewfrmPrint.TableID = "APL010"
...
EventExitSub:
    ...
    Private Sub frmAPL010_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmAPL010_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Ini_Scr()
        ...
        medPrdTo.Text = VB.Left(gsSystemDate, 4) & "/" & Mid(gsSystemDate, 6, 2)
    ...
    'UPGRADE_WARNING: Event frmAPL010.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
    Private Sub frmAPL010_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
    ...
    Private Sub frmAPL010_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        wcCombo = Nothing
        'UPGRADE_NOTE: Object frmAPL010 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
