...
Friend Class frmAR001
	...
	Private Const wsKeyType As String = "ARINHD"
...
EventExitSub: 
	...
	Private Sub cboDocNo_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboDocNo.DropDown
		...
		wsSQL = "SELECT INHDDOCNO, INHDJOBNO, INHDDOCDATE, INHDCURR, SUM(INDTINVAMT), SUM(INDTBALAMT) "
		wsSQL = wsSQL & " FROM ARINHD, ARINDT "
		wsSQL = wsSQL & " WHERE INHDDOCNO LIKE '%" & IIf(cboDocNo.SelectionLength > 0, "", Set_Quote(cboDocNo.Text)) & "%' "
		wsSQL = wsSQL & " AND INHDDOCID  = INDTDOCID "
		wsSQL = wsSQL & " AND INHDTRNCODE  = '" & Set_Quote(wsTrnCd) & "' "
		'   wsSql = wsSql & " AND INHDUPDFLG = 'N'"
		'   wsSql = wsSql & " AND INHDSTATUS = '1'"
		'   wsSql = wsSql & " AND INHDPGMNO = 'AR001' "
		wsSQL = wsSQL & " GROUP BY INHDDOCNO, INHDJOBNO, INHDDOCDATE, INHDCURR "
		'   wsSql = wsSql & " HAVING SUM(INDTSTLAMT) = 0 AND SUM(INDTSTLAMTL) = 0"
...
EventExitSub: 
	...
	Private Function Chk_cboDocNo() As Boolean
		...
		If Chk_DocNo(cboDocNo.Text, wsStatus, wsTrnCode, wsUpdFlg, wsDocDate, wsPgmNo) = True Then
			...
			wsSQL = "SELECT SUM(INDTSTLAMT) STLAMT FROM ARINHD, ARINDT "
	...
	'UPGRADE_WARNING: Form event frmAR001.Activate has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
	Private Sub frmAR001_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
	...
	Private Sub frmAR001_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmAR001_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	Private Function LoadRecord() As Boolean
		...
		wsSQL = "SELECT INHDDOCID, INHDDOCNO, INHDCUSID, CUSID, CUSCODE, CUSNAME, CUSTEL, CUSFAX, "
		wsSQL = wsSQL & "INHDDOCDATE, INHDREVNO, INHDCURR, INHDEXCR, "
		wsSQL = wsSQL & "INHDDUEDATE, INHDPAYCODE, INHDSALEID, INHDMLCODE, INHDJOBNO, "
		wsSQL = wsSQL & "INHDRMKCODE, INHDRMK1,  INHDRMK2,  INHDRMK3,  INHDRMK4, INHDRMK5, "
		wsSQL = wsSQL & "INDTID, INDTMLCODE, INDTCATCODE, INDTCUSPO, INDTJOBNO, INDTINVAMT, INDTDESC "
		wsSQL = wsSQL & "FROM  ARINHD, ARINDT, mstCUSTOMER "
		wsSQL = wsSQL & "WHERE INHDDOCNO = '" & Set_Quote(cboDocNo.Text) & "' "
		wsSQL = wsSQL & "AND INHDDOCID = INDTDOCID "
		wsSQL = wsSQL & "AND INHDCUSID = CUSID "
		'      wsSql = wsSql & "AND INHDPGMNO = '" & wsFormID & "'"
		wsSQL = wsSQL & "AND INHDSTATUS <> '2'"
		wsSQL = wsSQL & "ORDER BY INDTDOCLINE "
		...
		wlKey = ReadRs(rsRcd, "INHDDOCID")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		txtRevNo.Text = VB6.Format(ReadRs(rsRcd, "INHDREVNO") + 1, "##0")
		wiRevNo = To_Value(ReadRs(rsRcd, "INHDREVNO"))
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		medDocDate.Text = ReadRs(rsRcd, "INHDDOCDATE")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		cboCurr.Text = ReadRs(rsRcd, "INHDCURR")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		txtExcr.Text = VB6.Format(ReadRs(rsRcd, "INHDEXCR"), gsExrFmt)
		
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		medDueDate.Text = Dsp_MedDate(ReadRs(rsRcd, "INHDDUEDATE"))
		
		wlSaleID = To_Value(ReadRs(rsRcd, "INHDSALEID"))
		
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		cboPayCode.Text = ReadRs(rsRcd, "INHDPAYCODE")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		cboMLCode.Text = ReadRs(rsRcd, "INHDMLCODE")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		cboRmkCode.Text = ReadRs(rsRcd, "INHDRMKCODE")
		
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		cboJobNo.Text = ReadRs(rsRcd, "INHDJOBNO")
		
		
		Dim i As Short
		
		For i = 1 To 5
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(rsRcd, INHDRMK & i). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			txtRmk(i).Text = ReadRs(rsRcd, "INHDRMK" & i)
		Next i
		...
		With waResult
			...
			Do While Not rsRcd.EOF
				...
				.AppendRows()
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), GMLCODE) = ReadRs(rsRcd, "INDTMLCODE")
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), GDESC) = ReadRs(rsRcd, "INDTDESC")
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), GCUSPO) = ReadRs(rsRcd, "INDTCUSPO")
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), GJOBNO) = ReadRs(rsRcd, "INDTJOBNO")
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), GAMT) = IIf(wsTrnCd = "60", VB6.Format(ReadRs(rsRcd, "INDTINVAMT") * -1, gsAmtFmt), VB6.Format(ReadRs(rsRcd, "INDTINVAMT"), gsAmtFmt))
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), GDTLID) = ReadRs(rsRcd, "INDTID")
				rsRcd.MoveNext()
			Loop 
		End With
		tblDetail.ReBind()
...
Ini_Caption_Err: 
	...
	Private Sub frmAR001_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseUp
	...
	'UPGRADE_WARNING: Event frmAR001.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmAR001_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Private Sub frmAR001_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        'UPGRADE_NOTE: Object frmAR001 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
    ...
    Private Function Chk_medDueDate() As Boolean
        ...
        If Chk_ValidDocDate(medDueDate.Text, "AR") = False Then
            tabDetailInfo.SelectedIndex = 0
            medDueDate.Focus()
            Exit Function
        End If
    ...
    Private Function Chk_KeyExist() As Boolean
        ...
        wsSQL = "SELECT INHDSTATUS FROM ARINHD WHERE INHDDOCNO = '" & Set_Quote(cboDocNo.Text) & "'"
        rsRcd.Open(wsSQL, cnCon, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockOptimistic)
        If rsRcd.RecordCount > 0 Then
    ...
    Private Function cmdSave() As Boolean
        ...
        adcmdSave.CommandText = "USP_AR001A"
        ...
        If waResult.get_UpperBound(1) >= 0 Then
            adcmdSave.CommandText = "USP_AR001B"
            adcmdSave.CommandType = ADODB.CommandTypeEnum.adCmdStoredProc
            adcmdSave.Parameters.Refresh()
            ...
            For wiCtr = 0 To waResult.get_UpperBound(1)
                If Trim(waResult.get_Value(wiCtr, GMLCODE)) <> "" Then
                    ...
                    wdTmpAmt = CDbl(NBRnd(IIf(wsTrnCd = "60", To_Value(waResult.get_Value(wiCtr, GAMT)) * -1, To_Value(waResult.get_Value(wiCtr, GAMT))), giAmtDp))
                    Call SetSPPara(adcmdSave, 8, wdTmpAmt)
                    wdTmpAmt = CDbl(NBRnd(IIf(wsTrnCd = "60", To_Value(waResult.get_Value(wiCtr, GAMT)) * To_Value((txtExcr.Text)) * -1, To_Value(waResult.get_Value(wiCtr, GAMT)) * To_Value((txtExcr.Text))), giAmtDp))
...
Chk_GrdRow_Err: 
	...
	Private Function cmdDel() As Boolean
		...
		adcmdDelete.CommandText = "USP_AR001A"
		...
		Call SetSPPara(adcmdDelete, 6, wlCusID)
...
cmdDelete_Err: 
	...
	Private Sub OpenPromptForm()
		...
		Me.Cursor = System.Windows.Forms.Cursors.WaitCursor
		With frmShareSearch
			wsSQL = "SELECT INHdDocNo, InHdDocDate, mstCustomer.CusCode,  mstCustomer.CusName "
			wsSQL = wsSQL & "FROM MstCustomer, ArINHD "
			.sBindSQL = wsSQL
			.sBindWhereSQL = "WHERE InHdStatus = '1' And INHdCusID = CusID "
			.sBindOrderSQL = "ORDER BY InHdDocNo"
		...
		'UPGRADE_ISSUE: Form property frmAR001.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
...
EventExitSub: 
	...
	Private Function Chk_cboMLCode() As Boolean
		...
		If Chk_MLClass(cboMLCode.Text, "A", wsDesc) = False Then
			gsMsg = "沒有此會計分類!"
			MsgBox(gsMsg, MsgBoxStyle.OKOnly, gsTitle)
			tabDetailInfo.SelectedIndex = 0
			cboMLCode.Focus()
...
EventExitSub: 
	...
	Private Sub tblDetail_MouseUpEvent(ByVal eventSender As System.Object, ByVal eventArgs As AxTrueDBGrid60.TrueDBGridEvents_MouseUpEvent) Handles tblDetail.MouseUpEvent
		If eventArgs.Button = 2 Then
			'UPGRADE_ISSUE: Form method frmAR001.PopupMenu was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
            'PopupMenu(mnuPopUp)
		End If
	...
	Private Function Chk_DocNo(ByVal InDocNo As String, ByRef OutStatus As String, ByRef OutTrnCd As String, ByRef OutUpdFlg As String, ByRef OutDocDate As String, ByRef OutPgmNo As String) As Boolean
		...
		wsSQL = "SELECT INHDTRNCODE, INHDSTATUS, INHDUPDFLG, INHDDOCDATE, INHDPGMNO FROM ARINHD "
		wsSQL = wsSQL & " WHERE INHDDOCNO = '" & Set_Quote(InDocNo) & "'"
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		OutStatus = ReadRs(rsRcd, "INHDSTATUS")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		OutTrnCd = ReadRs(rsRcd, "INHDTRNCODE")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		OutUpdFlg = ReadRs(rsRcd, "INHDUPDFLG")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		OutDocDate = ReadRs(rsRcd, "INHDDOCDATE")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		OutPgmNo = ReadRs(rsRcd, "INHDPGMNO")
