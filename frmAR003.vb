...
Friend Class frmAR003
	...
	Private Const IINDTID As Short = 7
	...
	Private Const wsKeyType As String = "ARSTHD"
	Private Const wsInvKeyType As String = "ARINHD" 'Use for the locking
	...
	Private Sub Ini_Scr()
		...
		waInvoice.ReDim(0, -1, IINVNO, IINDTID)
...
EventExitSub: 
	...
	Private Sub cboDocNo_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboDocNo.DropDown
		...
		wsSQL = wsSQL & " WHERE ARSHDOCNO LIKE '%" & IIf(cboDocNo.SelectionLength > 0, "", Set_Quote(cboDocNo.Text)) & "%' "
		' wsSql = wsSql & " AND ARSHUPDFLG = 'N'"
		' wsSql = wsSql & " AND ARSHSTATUS = '1'"
		' wsSql = wsSql & " AND ARSHPGMNO = '" & wsFormID & "' "
		wsSQL = wsSQL & " ORDER BY ARSHDOCNO, ARSHDOCDATE "
...
EventExitSub: 
	...
	Private Function Chk_cboDocNo() As Boolean
		...
		Else
			...
			wsSQL = wsSQL & " WHERE ARCQCHQNO = '" & Set_Quote(cboDocNo.Text) & "' "
			...
			wsSQL = wsSQL & " WHERE INHDDOCNO = '" & Set_Quote(cboDocNo.Text) & "' "
	...
	Private Sub Ini_Scr_AfrKey()
		...
		If cboCusCode.Enabled = False Then
			cboCurr.Focus()
		Else
			cboCusCode.Focus()
		End If
	...
	'UPGRADE_WARNING: Form event frmAR003.Activate has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
	Private Sub frmAR003_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
	...
	Private Sub frmAR003_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmAR003_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	Private Function LoadRecord() As Boolean
		...
		wsSQL = "SELECT ARSHDOCID, ARSHDOCNO, ARSHCUSID, CUSID, CUSCODE, CUSNAME, CUSTEL, CUSFAX, "
		wsSQL = wsSQL & "ARSHDOCDATE, ARSHCURR, ARSHEXCR, ARSHCATCODE, ARSHMLCODE, "
		wsSQL = wsSQL & "ARSHCHQAMT, ARSHCHQAMTL, ARSHREMARK "
		wsSQL = wsSQL & "FROM  ARSTHD, mstCUSTOMER "
		wsSQL = wsSQL & "WHERE ARSHDOCNO = '" & Set_Quote(cboDocNo.Text) & "' "
		...
		wlKey = ReadRs(rsRcd, "ARSHDOCID")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		medDocDate.Text = ReadRs(rsRcd, "ARSHDOCDATE")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		cboCurr.Text = ReadRs(rsRcd, "ARSHCURR")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		txtExcr.Text = VB6.Format(ReadRs(rsRcd, "ARSHEXCR"), gsExrFmt)
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		txtChqAmtOrg.Text = NBRnd(ReadRs(rsRcd, "ARSHCHQAMT"), giAmtDp)
		If To_Value((txtChqAmtOrg.Text)) > 0 Then Call SetFieldStatus("RemTrue")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		LblDspChqAmtLoc.Text = NBRnd(ReadRs(rsRcd, "ARSHCHQAMTL"), giAmtDp)
		
		
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		cboMLCode.Text = ReadRs(rsRcd, "ARSHMLCODE")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		txtRmk.Text = ReadRs(rsRcd, "ARSHREMARK")
		lblDspMLDesc.Text = Get_TableInfo("mstMerchClass", "MLCode ='" & Set_Quote(cboMLCode.Text) & "'", "MLDESC")
		
		rsRcd.Close()
		
		
		wsSQL = " SELECT INDTID, INHDDOCNO, INDTDOCLINE, ARSDCURR, INDTBALAMT AS BAL, "
		wsSQL = wsSQL & " ARSDTRNAMT * -1 AS TRNAMT, ARSDTRNAMTL * -1 AS TRNAMTL, INHDEXCR "
		wsSQL = wsSQL & " FROM  ARSTDT, ARINDT, ARINHD "
		wsSQL = wsSQL & " WHERE ARSDDOCID  = " & wlKey
		wsSQL = wsSQL & " AND   ARSDLNTYP  = 'I' "
		wsSQL = wsSQL & " AND   ARSDINDTID = INDTID "
		wsSQL = wsSQL & " AND   INHDDOCID = INDTDOCID "
		wsSQL = wsSQL & " ORDER BY ARSDDOCLINE "
		...
		If rsRcd.RecordCount > 0 Then
			...
			rsRcd.MoveFirst()
			With waInvoice
				.ReDim(0, -1, IINVNO, IINDTID)
				Do While Not rsRcd.EOF
					.AppendRows()
					'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					waInvoice.get_Value(.get_UpperBound(1), IINVNO) = ReadRs(rsRcd, "INHDDOCNO")
					waInvoice.get_Value(.get_UpperBound(1), ILINE) = VB6.Format(To_Value(ReadRs(rsRcd, "INDTDOCLINE")), "000")
					'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					waInvoice.get_Value(.get_UpperBound(1), ICURR) = ReadRs(rsRcd, "ARSDCURR")
					'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					waInvoice.get_Value(.get_UpperBound(1), IEXCR) = ReadRs(rsRcd, "INHDEXCR")
					...
					'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					waInvoice.get_Value(.get_UpperBound(1), IINDTID) = ReadRs(rsRcd, "INDTID")
					
					'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					If NoMoreInvNo(waInvoice, ReadRs(rsRcd, "INHDDOCNO"), .get_UpperBound(1)) Then
						'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						If RowLock(wsConnTime, wsInvKeyType, ReadRs(rsRcd, "INHDDOCNO"), wsFormID, wsUsrId) = False Then
							gsMsg = "記錄已被以下使用者鎖定 : " & wsUsrId
							MsgBox(gsMsg, MsgBoxStyle.OKOnly, gsTitle)
						End If
					End If
		...
		wsSQL = " SELECT ARSDMLCODE, ARSDDOCLINE, ARSDCURR, ARSDEXCR, "
		wsSQL = wsSQL & " ARSDTRNAMT, ARSDTRNAMTL "
		wsSQL = wsSQL & " FROM  ARSTDT "
		wsSQL = wsSQL & " WHERE ARSDDOCID  = " & wlKey
		wsSQL = wsSQL & " AND   ARSDLNTYP  = 'O' "
		wsSQL = wsSQL & " ORDER BY ARSDDOCLINE "
		...
		If rsRcd.RecordCount > 0 Then
			...
			With waResult
				...
				Do While Not rsRcd.EOF
					.AppendRows()
					'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					waResult.get_Value(.get_UpperBound(1), OMLCODE) = ReadRs(rsRcd, "ARSDMLCODE")
					'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					waResult.get_Value(.get_UpperBound(1), OCURR) = ReadRs(rsRcd, "ARSDCURR")
					'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					waResult.get_Value(.get_UpperBound(1), OEXCR) = ReadRs(rsRcd, "ARSDEXCR")
					waResult.get_Value(.get_UpperBound(1), OOTHAMTORG) = VB6.Format(To_Value(ReadRs(rsRcd, "ARSDTRNAMT")) * -1, gsAmtFmt)
					waResult.get_Value(.get_UpperBound(1), OOTHAMTLOC) = VB6.Format(To_Value(ReadRs(rsRcd, "ARSDTRNAMTL")) * -1, gsAmtFmt)
		...
		wsSQL = " SELECT ARSDMLCODE, INHDMLCODE, "
		wsSQL = wsSQL & " ARSDTRNAMT, ARSDTRNAMTL "
		wsSQL = wsSQL & " FROM  ARSTHD, ARSTDT, ARINHD "
		wsSQL = wsSQL & " WHERE ARSDDOCID  = " & wlKey
		wsSQL = wsSQL & " AND ARSDLNTYP  = 'R' "
		wsSQL = wsSQL & " AND ARSHDOCID  = ARSDDOCID "
		wsSQL = wsSQL & " AND ARSHDOCNO = INHDDOCNO "
		...
		If rsRcd.RecordCount > 0 Then
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			txtRemAmt.Text = NBRnd(0 - CDbl(NBRnd(ReadRs(rsRcd, "ARSDTRNAMT"), giAmtDp)), giAmtDp)
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			lblDspRemAmtl.Text = NBRnd(0 - CDbl(NBRnd(ReadRs(rsRcd, "ARSDTRNAMTL"), giAmtDp)), giAmtDp)
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
Ini_Caption_Err: 
	...
	Private Sub frmAR003_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseUp
	...
	'UPGRADE_WARNING: Event frmAR003.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmAR003_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Private Sub frmAR003_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        'UPGRADE_NOTE: Object frmAR003 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() '  = Nothing
    ...
    Private Function Chk_KeyExist() As Boolean
        ...
        wsSQL = "SELECT ARSHSTATUS FROM ARSTHD WHERE ARSHDOCNO = '" & Set_Quote(cboDocNo.Text) & "'"
        rsRcd.Open(wsSQL, cnCon, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockOptimistic)
        If rsRcd.RecordCount > 0 Then
    ...
    Private Function cmdSave() As Boolean
        ...
        adcmdSave.CommandText = "USP_AR003A"
        ...
        If waInvoice.get_UpperBound(1) >= 0 Then
            adcmdSave.CommandText = "USP_AR003B"
            adcmdSave.CommandType = ADODB.CommandTypeEnum.adCmdStoredProc
            adcmdSave.Parameters.Refresh()
            ...
            For wiCtr = 0 To waInvoice.get_UpperBound(1)
                If IsEmptyInvRow(wiCtr) = False Then
                    Call SetSPPara(adcmdSave, 1, wiAction)
                    Call SetSPPara(adcmdSave, 2, wlKey)
                    Call SetSPPara(adcmdSave, 3, waInvoice.get_Value(wiCtr, IINDTID))
        ...
        With tblInvoice
            ...
            Select Case eventArgs.ColIndex
                Case IINVNO
                    ...
                    wsSQL = "SELECT INHDDOCNO ,"
                    wsSQL = wsSQL & " CONVERT(NVARCHAR(5), REPLICATE('0',3 - LEN(LTRIM(CONVERT(NVARCHAR(3),INDTDOCLINE))))  + CONVERT(NVARCHAR(3),INDTDOCLINE)), "
                    wsSQL = wsSQL & " INHDJOBNO, "
                    wsSQL = wsSQL & " INDTINVAMT, "
                    wsSQL = wsSQL & " INDTBALAMT FROM ARINHD, ARINDT "
                    wsSQL = wsSQL & " WHERE INHDDOCNO LIKE '%" & IIf(Trim(.SelText) <> "", "", Set_Quote(.Columns(IINVNO).Text)) & "%'"
                    wsSQL = wsSQL & " AND INHDDOCDATE <= '" & Set_Quote(medDocDate.Text) & "'"
                    wsSQL = wsSQL & " AND INHDCUSID = " & wlCusID
                    wsSQL = wsSQL & " AND INDTBALAMT <> 0  "
                    wsSQL = wsSQL & " AND INHDSTATUS <> '2' "
                    wsSQL = wsSQL & " AND INHDDOCID = INDTDOCID "

                    If waInvoice.get_UpperBound(1) > -1 Then
                        wsSQL = wsSQL & " AND INHDDOCNO + CONVERT(NVARCHAR(5), REPLICATE('0',3 - LEN(LTRIM(CONVERT(NVARCHAR(3),INDTDOCLINE))))  + CONVERT(NVARCHAR(3),INDTDOCLINE)) NOT IN ( "
                        For wiCtr = 0 To waInvoice.get_UpperBound(1)
                            wsSQL = wsSQL & " '" & waInvoice.get_Value(wiCtr, IINVNO) & waInvoice.get_Value(wiCtr, ILINE) & IIf(wiCtr = waInvoice.get_UpperBound(1), "' )", "' ,")
                        Next
                    End If
                    wsSQL = wsSQL & " ORDER BY INHDDOCNO, CONVERT(NVARCHAR(5), REPLICATE('0',3 - LEN(LTRIM(CONVERT(NVARCHAR(3),INDTDOCLINE))))  + CONVERT(NVARCHAR(3),INDTDOCLINE))"
...
tblInvoice_KeyDown_Err:
    ...
    Private Sub tblInvoice_MouseUpEvent(ByVal eventSender As System.Object, ByVal eventArgs As AxTrueDBGrid60.TrueDBGridEvents_MouseUpEvent) Handles tblInvoice.MouseUpEvent
        If eventArgs.Button = 2 Then
            'UPGRADE_ISSUE: Form method frmAR003.PopupMenu was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
            'PopupMenu(mnuIPopUp)
        End If
...
EventExitSub:
    ...
    Private Sub cboCusCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusCode.DropDown
        ...
        Else
            ...
            wsSQL = wsSQL & "ORDER BY CUSCODE "
        End If
        Call Ini_Combo(2, wsSQL, (VB6.PixelsToTwipsX(cboCusCode.Left)), VB6.PixelsToTwipsY(cboCusCode.Top) + VB6.PixelsToTwipsY(cboCusCode.Height), tblCommon, wsFormID, "TBLCUSNO", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
...
EventExitSub:
    ...
    Private Function chk_cboCusCode() As Boolean
        ...
        If Chk_CusCode(cboCusCode.Text, wlID, wsName, wsTel, wsFax) Then
            wlCusID = wlID
    ...
    Private Sub Get_DefVal()
        ...
        If rsDefVal.RecordCount > 0 Then
            ...
            'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            cboTMPML.Text = ReadRs(rsDefVal, "CUSMLCODE")
...
Calc_InvTotal_Err: 
	...
	Private Function cmdDel() As Boolean
		...
		adcmdDelete.CommandText = "USP_AR003A"
...
cmdDelete_Err: 
	...
	Private Sub OpenPromptForm()
		...
		Me.Cursor = System.Windows.Forms.Cursors.WaitCursor
		With frmShareSearch
			wsSQL = "SELECT ARSHDocNo, ARSHDocDate, mstCustomer.CusCode,  mstCustomer.CusName "
			wsSQL = wsSQL & "FROM MstCustomer, ArStHd "
			.sBindSQL = wsSQL
			.sBindWhereSQL = "WHERE ARSHStatus = '1' And ARSHCusID = CusID "
			.sBindOrderSQL = "ORDER BY ARSHDocNo"
		...
		'UPGRADE_ISSUE: Form property frmAR003.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
...
EventExitSub: 
	...
	Private Function Chk_cboTmpML() As Boolean
		...
		If Chk_MLClass(cboTMPML.Text, "A", wsDesc) = False Then
			gsMsg = "沒有此會計分類!"
			MsgBox(gsMsg, MsgBoxStyle.OKOnly, gsTitle)
			cboTMPML.Focus()
...
EventExitSub: 
	...
	Private Function Chk_DocNo(ByVal InDocNo As String, ByRef OutStatus As String, ByRef OutUpdFlg As String, ByRef OutPgmNo As String) As Boolean
		...
		wsSQL = "SELECT ARSHSTATUS, ARSHUPDFLG, ARSHPGMNO FROM ARSTHD "
		wsSQL = wsSQL & " WHERE ARSHDOCNO = '" & Set_Quote(InDocNo) & "' "
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		OutStatus = ReadRs(rsRcd, "ARSHSTATUS")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		OutUpdFlg = ReadRs(rsRcd, "ARSHUPDFLG")
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		OutPgmNo = ReadRs(rsRcd, "ARSHPGMNO")
	...
	Private Function Chk_CusCode(ByVal InCusNo As String, ByRef OutID As Integer, ByRef OutName As String, ByRef OutTel As String, ByRef OutFax As String) As Boolean
...
Calc_ChargeTotal_Err: 
	...
	Private Function Chk_InvNo(ByVal inInvNo As String, ByVal inInvLn As String, Optional ByRef inDtl As Boolean = False) As Boolean
		...
		wsSQL = "SELECT INDTID, INHDDOCNO , REPLICATE('0',3 - LEN(LTRIM(CONVERT(NVARCHAR(3),INDTDOCLINE))))  + CONVERT(NVARCHAR(3),INDTDOCLINE) AS LN, "
		wsSQL = wsSQL & " INHDCURR, INDTBALAMT, INDTBALAMTL, INHDEXCR FROM ARINHD, ARINDT "
		wsSQL = wsSQL & " WHERE INHDDOCNO = '" & Set_Quote(inInvNo) & "'"
		wsSQL = wsSQL & " AND  REPLICATE('0',3 - LEN(LTRIM(CONVERT(NVARCHAR(3),INDTDOCLINE))))  + CONVERT(NVARCHAR(3),INDTDOCLINE) = '" & Set_Quote(VB6.Format(inInvLn, "00#")) & "'"
		wsSQL = wsSQL & " AND INHDCUSID = " & wlCusID
		wsSQL = wsSQL & " AND INHDDOCID = INDTDOCID AND INDTBALAMT <> 0"
		wsSQL = wsSQL & " AND INHDSTATUS <> '2'"
		...
		With tblInvoice
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			.Columns(IINVNO).Text = ReadRs(rsRcd, "INHDDOCNO")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			.Columns(ILINE).Text = ReadRs(rsRcd, "LN")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			.Columns(ICURR).Text = ReadRs(rsRcd, "INHDCURR")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			.Columns(IOSAMT).Text = NBRnd(ReadRs(rsRcd, "INDTBALAMT"), giAmtDp)
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			.Columns(ISETAMTORG).Text = NBRnd(ReadRs(rsRcd, "INDTBALAMT"), giAmtDp)
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			.Columns(ISETAMTLOC).Text = NBRnd(ReadRs(rsRcd, "INDTBALAMTL"), giAmtDp)
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			.Columns(IEXCR).Text = ReadRs(rsRcd, "INHDEXCR")
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			.Columns(IINDTID).Text = ReadRs(rsRcd, "INDTID")
