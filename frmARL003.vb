...
Friend Class frmARL003
	...
	Private Sub cmdOK()
		...
		wsDteTim = CStr(Now)
		wsSql = "EXEC usp_RPTARL003 '" & Set_Quote(gsUserID) & "', "
		...
		If gsLangID = "2" Then
			wsRptName = "C" & "RPTARL003"
		Else
			wsRptName = "RPTARL003"
		End If
		
		NewfrmPrint.ReportID = "ARL003"
		NewfrmPrint.RptTitle = Me.Text
		NewfrmPrint.TableID = "ARL003"
...
EventExitSub: 
	...
	Private Sub frmARL003_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmARL003_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	'UPGRADE_WARNING: Event frmARL003.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmARL003_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Private Sub frmARL003_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		...
		wcCombo = Nothing
		'UPGRADE_NOTE: Object frmARL003 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
	...
	Private Sub cboDocNoFr_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboDocNoFr.DropDown
		...
		wsSql = "(SELECT ARSHDOCNO, ARSHDOCDATE FROM ARSTHD) UNION (SELECT ARCQCHQNO, ARCQCHQDATE FROM ARCHEQUE) "
