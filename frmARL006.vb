...
Friend Class frmARL006
	...
	Private Sub cmdOK()
		...
		wsDteTim = CStr(Now)
		wsSQL = "EXEC usp_RPTARL006 '" & Set_Quote(gsUserID) & "', "
		...
		If gsLangID = "2" Then
			wsRptName = "C" & "RPTARL006"
		Else
			wsRptName = "RPTARL006"
		End If
		
		NewfrmPrint.ReportID = "ARL006"
		NewfrmPrint.RptTitle = Me.Text
		NewfrmPrint.TableID = "ARL006"
...
cmdSave_Err: 
	...
	Private Sub frmARL006_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmARL006_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
    ...
    'UPGRADE_WARNING: Event frmARL006.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
    Private Sub frmARL006_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
    ...
    Private Sub frmARL006_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        waResult = Nothing
        'UPGRADE_NOTE: Object frmARL006 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
    End Sub
