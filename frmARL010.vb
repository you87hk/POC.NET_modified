...
Friend Class frmARL010
	...
	Private Sub cmdOK()
		...
		wsDteTim = CStr(Now)
		wsSQL = "EXEC usp_RPTARL010 '" & Set_Quote(gsUserID) & "', "
		...
		If gsLangID = "2" Then
			wsRptName = "C" & "RPTARL010"
		Else
			wsRptName = "RPTARL010"
		End If
		
		NewfrmPrint.ReportID = "ARL010"
		NewfrmPrint.RptTitle = Me.Text
		NewfrmPrint.TableID = "ARL010"
...
EventExitSub:
    ...
    Private Sub frmARL010_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmARL010_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
    ...
    'UPGRADE_WARNING: Event frmARL010.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
    Private Sub frmARL010_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
    ...
    Private Sub frmARL010_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        wcCombo = Nothing
        'UPGRADE_NOTE: Object frmARL010 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
...
EventExitSub:
    ...
    Private Sub cboDocNoFr_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboDocNoFr.DropDown
        ...
        wsSQL = "SELECT ARCQCHQNO, ARCQCHQDATE "
        wsSQL = wsSQL & "FROM ARCHEQUE "
        wsSQL = wsSQL & "WHERE ARCQCHQNO LIKE '%" & IIf(cboDocNoFr.SelectionLength > 0, "", Set_Quote(cboDocNoFr.Text)) & "%' "
    ...
    Private Sub cboDocNoTo_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboDocNoTo.DropDown
        ...
        wsSQL = "SELECT ARCQCHQNO, ARCQCHQDATE "
        wsSQL = wsSQL & "FROM ARCHEQUE "
        wsSQL = wsSQL & "WHERE ARCQCHQNO LIKE '%" & IIf(cboDocNoTo.SelectionLength > 0, "", Set_Quote(cboDocNoTo.Text)) & "%' "
        wsSQL = wsSQL & "ORDER BY ARCQCHQNO"
