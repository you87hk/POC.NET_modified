...
Friend Class frmARL012
	...
	Private Sub cmdOK()
		...
		wsDteTim = CStr(Now)
		wsSQL = "EXEC usp_RPTARL012 '" & Set_Quote(gsUserID) & "', "
		...
		NewfrmPrint.ReportID = "ARL012"
		NewfrmPrint.RptTitle = Me.Text
		NewfrmPrint.TableID = "ARL012"
...
EventExitSub: 
	...
	Private Sub frmARL012_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmARL012_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	'UPGRADE_WARNING: Event frmARL012.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmARL012_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Private Sub frmARL012_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		...
		wcCombo = Nothing
		'UPGRADE_NOTE: Object frmARL012 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
