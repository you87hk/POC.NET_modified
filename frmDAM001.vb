...
EventExitSub: 
	...
	Private Sub Ini_Scr_AfrKey()
		...
		If LoadRecord() = False Then
			...
			cboMLCode.Text = Get_CompanyFlag("CmpDamMLCode")
			cboSaleCode.Focus()
		Else
			wiAction = CorRec
...
EventExitSub:
    ...
    'UPGRADE_WARNING: Form event frmDAM001.Activate has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
    Private Sub frmDAM001_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub frmDAM001_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmDAM001_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Ini_Caption()
        ...
        wsActNam(1) = Get_Caption(waScrItm, "DAMADD")
        wsActNam(2) = Get_Caption(waScrItm, "DAMEDIT")
        wsActNam(3) = Get_Caption(waScrItm, "DAMDELETE")

        wgsTitle = Get_Caption(waScrItm, "TITLE")
        wgsTRTitle = Get_Caption(waScrItm, "DMTITLE")
...
Ini_Caption_Err:
    ...
    Private Sub frmDAM001_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseUp
    ...
    'UPGRADE_WARNING: Event frmDAM001.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
    Private Sub frmDAM001_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
    ...
    Private Sub frmDAM001_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        'UPGRADE_NOTE: Object frmDAM001 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
        ...
        If waResult.get_UpperBound(1) >= 0 Then
            ...
            For wiCtr = 0 To waResult.get_UpperBound(1)
                If Trim(waResult.get_Value(wiCtr, ITMCODE)) <> "" Then
                    ...
                    Call SetSPPara(adcmdSave, 9, "STKOUT")
                    Call SetSPPara(adcmdSave, 10, cboMLCode.Text)
...
cmdDelete_Err:
    ...
    Private Sub OpenPromptForm()
        ...
        'UPGRADE_ISSUE: Form property frmDAM001.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
    ...
    Private Sub tblDetail_MouseUpEvent(ByVal eventSender As System.Object, ByVal eventArgs As AxTrueDBGrid60.TrueDBGridEvents_MouseUpEvent) Handles tblDetail.MouseUpEvent
        If eventArgs.Button = 2 Then
            'UPGRADE_ISSUE: Form method frmDAM001.PopupMenu was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
            'PopupMenu(mnuPopUp)
        End If
