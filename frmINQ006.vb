...
Friend Class frmINQ006
	...
	Private Const SUPRICE As Short = 3
	Private Const SSTKQTY As Short = 4
	Private Const SAMTL As Short = 5
	Private Const SINDQTY As Short = 6
	Private Const SALLQTY As Short = 7
	Private Const SORDQTY As Short = 8
	Private Const SRDRQTY As Short = 9
	Private Const SPOQTY As Short = 10
	Private Const SPODATE As Short = 11
	Private Const SPORTN As Short = 12
	Private Const SID As Short = 13
	Private Const SDUMMY As Short = 14
...
EventExitSub: 
	...
	'UPGRADE_WARNING: Event frmINQ006.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmINQ006_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
...
EventExitSub: 
	...
	Private Sub frmINQ006_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmINQ006_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	Private Sub frmINQ006_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		
		
		cnCon.Execute("DELETE FROM RPTINQ006 WHERE RPTUSRID = '" & gsUserID & "' AND RPTDTETIM = '" & wsDteTim & "' ")
		...
		waResult = Nothing
		'UPGRADE_NOTE: Object frmINQ006 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
	...
	Private Sub Ini_Caption()
		...
		With tblDetail
			...
			.Columns(SINDQTY).Caption = Get_Caption(waScrItm, "SINDQTY")
			.Columns(SALLQTY).Caption = Get_Caption(waScrItm, "SALLQTY")
			.Columns(SORDQTY).Caption = Get_Caption(waScrItm, "SORDQTY")
			...
			.Columns(SPODATE).Caption = Get_Caption(waScrItm, "SPODATE")
			.Columns(SPORTN).Caption = Get_Caption(waScrItm, "SPORTN")
		End With
...
tblCommon_LostFocus_Err: 
	...
	Private Function LoadRecord() As Boolean
		...
		wsSQL = "SELECT RPTITMID, RPTITMCODE, RPTITMNAME, RPTUPRICE, RPTITMTYPECODE, RPTINDQTY, RPTALLQTY, RPTORDQTY, RPTSTKQTY, RPTAMTL, RPTRDRQTY, RPTPOQTY, RPTPODATE, RPTPORTN "
		wsSQL = wsSQL & " From RPTINQ006 "
		...
		If rsRcd.RecordCount <= 0 Then
			...
			'UPGRADE_ISSUE: Form property frmINQ006.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
		...
		With waResult
			...
			Do Until rsRcd.EOF
				...
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), SINDQTY) = VB6.Format(ReadRs(rsRcd, "RPTINDQTY"), gsQtyFmt)
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), SALLQTY) = VB6.Format(ReadRs(rsRcd, "RPTALLQTY"), gsQtyFmt)
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), SORDQTY) = VB6.Format(ReadRs(rsRcd, "RPTORDQTY"), gsQtyFmt)
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				...
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), SRDRQTY) = VB6.Format(ReadRs(rsRcd, "RPTRDRQTY"), gsQtyFmt)
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				...
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), SPODATE) = ReadRs(rsRcd, "RPTPODATE")
				waResult.get_Value(.get_UpperBound(1), SPORTN) = ""
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
EventExitSub: 
	...
	Private Sub cmdSave()
		...
		adcmdSave.CommandText = "USP_RPTINQ006"
