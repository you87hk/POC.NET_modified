...
Friend Class frmINQ007
	...
	Private Const SITMTYPECODE As Short = 2
	Private Const SDATE As Short = 3
	Private Const STRNCODE As Short = 4
	...
	Private Sub cboItmAccTypeCodeFr_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboItmAccTypeCodeFr.DropDown
		...
		Call Ini_Combo(2, wsSQL, (VB6.FromPixelsUserX(cboItmAccTypeCodeFr.Left, 0, 11923.8, 794)), VB6.FromPixelsUserY(cboItmAccTypeCodeFr.Top, 0, 8620.47, 575) + VB6.FromPixelsUserHeight(cboItmAccTypeCodeFr.Height, 8620.47, 575), tblCommon, wsFormID, "TBLITMBARCODE", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
    ...
    Private Sub cboItmAccTypeCodeTo_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboItmAccTypeCodeTo.DropDown
        ...
        Call Ini_Combo(2, wsSQL, (VB6.FromPixelsUserX(cboItmAccTypeCodeTo.Left, 0, 11923.8, 794)), VB6.FromPixelsUserY(cboItmAccTypeCodeTo.Top, 0, 8620.47, 575) + VB6.FromPixelsUserHeight(cboItmAccTypeCodeTo.Height, 8620.47, 575), tblCommon, wsFormID, "TBLITMBARCODE", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
        tblCommon.Visible = True
        tblCommon.Focus()
        Me.Cursor = System.Windows.Forms.Cursors.Default
    End Sub
...
EventExitSub:
    ...
    Private Sub choWhsCodeFr_Change()

    End Sub

    'UPGRADE_WARNING: Event frmINQ007.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
    Private Sub frmINQ007_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
...
EventExitSub:
    ...
    Private Sub frmINQ007_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmINQ007_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmINQ007_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        waResult = Nothing
        'UPGRADE_NOTE: Object frmINQ007 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
    ...
    Private Sub Ini_Caption()
        ...
        lblItmAccTypeCodeFr.Text = Get_Caption(waScrItm, "ItmBARCODEFR")
        lblItmAccTypeCodeTo.Text = Get_Caption(waScrItm, "ItmBARCODETO")
...
tblCommon_LostFocus_Err:
    ...
    Private Function LoadRecord() As Boolean
        ...
        wsSQL = "SELECT RPTBATCHNO, RPTITMID, RPTITMCODE, RPTITMNAME, RPTITMTYPECODE, RPTTRNCODE, RPTTRNDATE, RPTDOCNO, RPTWHSCODE, SUM(RPTSTKIN) SIN, "
        wsSQL = wsSQL & " SUM(RPTSTKOUT) SOUT "
        wsSQL = wsSQL & " From RPTINQ007 "
        wsSQL = wsSQL & " WHERE RPTUSRID = '" & gsUserID & "' "
        wsSQL = wsSQL & " AND RPTDTETIM = '" & wsDteTim & "' "
        wsSQL = wsSQL & " GROUP BY RPTBATCHNO, RPTITMID, RPTITMCODE, RPTITMNAME, RPTITMTYPECODE, RPTTRNCODE, RPTTRNDATE, RPTDOCNO, RPTWHSCODE "
        wsSQL = wsSQL & " ORDER BY RPTBATCHNO, RPTITMCODE "
        ...
        If rsRcd.RecordCount <= 0 Then
            ...
            'UPGRADE_ISSUE: Form property frmINQ007.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
        ...
        With waResult
            ...
            Do Until rsRcd.EOF
                ...
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), SDATE) = ReadRs(rsRcd, "RPTTRNDATE")
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                ...
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), SSTKIN) = VB6.Format(ReadRs(rsRcd, "SIN"), gsQtyFmt)
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), SSTKOUT) = VB6.Format(ReadRs(rsRcd, "SOUT"), gsQtyFmt)
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), SITMTYPECODE) = ReadRs(rsRcd, "RPTITMTYPECODE")
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                ...
                wdInQty = wdInQty + To_Value(ReadRs(rsRcd, "SIN"))
                wdOutQty = wdOutQty + To_Value(ReadRs(rsRcd, "SOUT"))
                rsRcd.MoveNext()
            Loop
        End With
        ...
        tblDetail.ReBind()
        tblDetail.Bookmark = 0
        lblDspItmDesc.Text = "In : " & VB6.Format(wdInQty, gsQtyFmt) & ";  " & "Out : " & VB6.Format(wdOutQty, gsQtyFmt)
...
EventExitSub:
	...
	Private Sub cmdSave()
		...
		adcmdSave.CommandText = "USP_RPTINQ007"
