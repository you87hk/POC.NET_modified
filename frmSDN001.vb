...
Friend Class frmSDN001
	...
	Private Const GNET As Short = 9
	Private Const GDRMKID As Short = 10
	...
	Private Const wsKeyType As String = "SOASDHD"
...
EventExitSub:
    ...
    Private Sub cboCurr_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCurr.DropDown
        ...
        Call Ini_Combo(2, wsSQL, VB6.PixelsToTwipsX(cboCurr.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboCurr.Top) + VB6.PixelsToTwipsY(cboCurr.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "SDN001", "TBLCURCOD", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
    ...
    Private Sub cboDocNo_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboDocNo.DropDown
        ...
        wsSQL = "SELECT SDHDDOCNO,  SDHDREFNO, CUSCODE, CUSNAME, SDHDDOCDATE "
        wsSQL = wsSQL & " FROM SOASDHD, mstCUSTOMER "
        wsSQL = wsSQL & " WHERE SDHDDOCNO LIKE '%" & IIf(cboDocNo.SelectionLength > 0, "", Set_Quote(cboDocNo.Text)) & "%' "
        wsSQL = wsSQL & " AND SDHDCUSID  = CUSID "
        wsSQL = wsSQL & " AND SDHDSTATUS IN ('1','4') "
        wsSQL = wsSQL & " ORDER BY SDHDDOCNO DESC "
        Call Ini_Combo(5, wsSQL, VB6.PixelsToTwipsX(cboDocNo.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboDocNo.Top) + VB6.PixelsToTwipsY(cboDocNo.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "SDN001", "TBLDOCNO", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
...
EventExitSub:
    ...
    'UPGRADE_WARNING: Form event frmSDN001.Activate has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
    Private Sub frmSDN001_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub frmSDN001_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmSDN001_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
    ...
    Private Function LoadRecord() As Boolean
        ...
        wsSQL = "SELECT SDHDDOCID, SDHDDOCNO, SDHDREFDOCID, SDHDCUSID, CUSID, CUSCODE, CUSNAME, CUSTEL, CUSFAX, CUSEMAIL, SDPTJDOCLINE,"
        wsSQL = wsSQL & "SDHDDOCDATE, SDHDREVNO, SDHDCURR, SDHDEXCR, "
        wsSQL = wsSQL & "SDHDDUEDATE, SDHDPAYCODE, SDHDPRCCODE, SDHDSALEID, SDHDMLCODE, SDHDSPECDIS, "
        wsSQL = wsSQL & "SDHDCUSPO, SDHDLCNO, SDHDPORTNO, SDHDSHIPPER, SDHDSHIPFROM, SDHDSHIPTO, SDHDSHIPVIA, SDHDSHIPNAME, "
        wsSQL = wsSQL & "SDHDSHIPCODE, SDHDSHIPADR1,  SDHDSHIPADR2,  SDHDSHIPADR3,  SDHDSHIPADR4, "
        wsSQL = wsSQL & "SDHDRMKCODE, SDHDRMK1,  SDHDRMK2,  SDHDRMK3,  SDHDRMK4, SDHDRMK5, SDHDAPRFLG, "
        wsSQL = wsSQL & "SDHDRMK6,  SDHDRMK7,  SDHDRMK8,  SDHDRMK9, SDHDRMK10, "
        wsSQL = wsSQL & "SDHDGRSAMT , SDHDGRSAMTL, SDHDDISAMT, SDHDDISAMTL, SDHDNETAMT, SDHDNETAMTL, "
        wsSQL = wsSQL & "SDPTJID, SDPTJLNTYPE, SDPTJITEMID, SDPTJDESC1, SDPTJDESC2, SDPTJDESC3, SDPTJDESC4, SDPTJQTY, SDPTJUPRICE, SDPTJDISPER, "
        wsSQL = wsSQL & "SDPTJAMT, SDPTJAMTL, SDPTJDIS, SDPTJDISL, SDPTJNET, SDPTJNETL, SDPTJMARKUP, SDPTJUOM, SDPTJDPRICE, SDPTJDRMKID "
        wsSQL = wsSQL & "FROM  SOASDHD, SOASDPTJ, mstCUSTOMER "
        wsSQL = wsSQL & "WHERE SDHDDOCNO = '" & Set_Quote(cboDocNo.Text) & "' "
        ...
        wlKey = ReadRs(rsInvoice, "SDHDDOCID")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        wlRefDocID = ReadRs(rsInvoice, "SDHDREFDOCID")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        lblDspRevNo.Text = VB6.Format(ReadRs(rsInvoice, "SDHDREVNO"), "##0")
        cboRefDocNo.Text = Get_TableInfo("SOASOHD", "SOHDDOCID = " & wlRefDocID, "SOHDDOCNO")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        medDocDate.Text = ReadRs(rsInvoice, "SDHDDOCDATE")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ...
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        cboCurr.Text = ReadRs(rsInvoice, "SDHDCURR")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtExcr.Text = VB6.Format(ReadRs(rsInvoice, "SDHDEXCR"), gsExrFmt)

        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        medDueDate.Text = Dsp_MedDate(ReadRs(rsInvoice, "SDHDDUEDate"))

        wlSaleID = To_Value(ReadRs(rsInvoice, "SDHDSALEID"))

        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        cboPayCode.Text = ReadRs(rsInvoice, "SDHDPAYCODE")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        cboPrcCode.Text = ReadRs(rsInvoice, "SDHDPRCCODE")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        cboMLCode.Text = ReadRs(rsInvoice, "SDHDMLCODE")

        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        cboShipCode.Text = ReadRs(rsInvoice, "SDHDSHIPCODE")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        cboRmkCode.Text = ReadRs(rsInvoice, "SDHDRMKCODE")

        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtCusPo.Text = ReadRs(rsInvoice, "SDHDCUSPO")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtLcNo.Text = ReadRs(rsInvoice, "SDHDLCNO")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtPortNo.Text = ReadRs(rsInvoice, "SDHDPORTNO")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtSpecDis.Text = VB6.Format(ReadRs(rsInvoice, "SDHDSPECDIS"), gsAmtFmt)
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtDisAmt.Text = VB6.Format(ReadRs(rsInvoice, "SDHDDISAMT"), gsAmtFmt)


        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtShipFrom.Text = ReadRs(rsInvoice, "SDHDSHIPFROM")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtShipTo.Text = ReadRs(rsInvoice, "SDHDSHIPTO")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtShipVia.Text = ReadRs(rsInvoice, "SDHDSHIPVIA")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtShipName.Text = ReadRs(rsInvoice, "SDHDSHIPNAME")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtShipPer.Text = ReadRs(rsInvoice, "SDHDSHIPPER")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtShipAdr1.Text = ReadRs(rsInvoice, "SDHDSHIPADR1")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtShipAdr2.Text = ReadRs(rsInvoice, "SDHDSHIPADR2")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtShipAdr3.Text = ReadRs(rsInvoice, "SDHDSHIPADR3")
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtShipAdr4.Text = ReadRs(rsInvoice, "SDHDSHIPADR4")
        ...
        For i = 1 To 10
            'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(rsInvoice, SDHDRMK & i). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            txtRmk(i).Text = ReadRs(rsInvoice, "SDHDRMK" & i)
        Next i
        ...
        lblDspGrsAmtOrg.Text = VB6.Format(To_Value(ReadRs(rsInvoice, "SDHDGRSAMT")), gsAmtFmt)
        lblDspDisAmtOrg.Text = VB6.Format(To_Value(ReadRs(rsInvoice, "SDHDDISAMT")), gsAmtFmt)
        lblDspNetAmtOrg.Text = VB6.Format(To_Value(ReadRs(rsInvoice, "SDHDNETAMT")), gsAmtFmt)
        ...
        With waResult
            ...
            Do While Not rsInvoice.EOF
                ...
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), GDESC1) = ReadRs(rsInvoice, "SDPTJDESC1")
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), GQTY) = VB6.Format(ReadRs(rsInvoice, "SDPTJQTY"), gsQtyFmt)
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), GPRICE) = VB6.Format(ReadRs(rsInvoice, "SDPTJDPRICE"), gsAmtFmt)
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), GDISPER) = VB6.Format(ReadRs(rsInvoice, "SDPTJDISPER"), gsAmtFmt)
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), GMARKUP) = VB6.Format(ReadRs(rsInvoice, "SDPTJMARKUP"), gsAmtFmt)
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), GUOM) = ReadRs(rsInvoice, "SDPTJUOM")

                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), GAMT) = VB6.Format(ReadRs(rsInvoice, "SDPTJUPRICE"), gsAmtFmt)
                'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                waResult.get_Value(.get_UpperBound(1), GNET) = VB6.Format(ReadRs(rsInvoice, "SDPTJNET"), gsAmtFmt)
                waResult.get_Value(.get_UpperBound(1), GDRMKID) = To_Value(ReadRs(rsInvoice, "SDPTJDRMKID"))
                waResult.get_Value(.get_UpperBound(1), GMORE) = IIf(To_Value(ReadRs(rsInvoice, "SDPTJDRMKID")) <> 0, "Y", "N")
...
Ini_Caption_Err:
    ...
    Private Sub frmSDN001_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseUp
    ...
    'UPGRADE_WARNING: Event frmSDN001.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
    Private Sub frmSDN001_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
    ...
    Private Sub frmSDN001_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        'UPGRADE_NOTE: Object frmSDN001 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
...
tblCommon_LostFocus_Err:
    ...
    Private Function Chk_KeyExist() As Boolean
        ...
        wsSQL = "SELECT SDHDSTATUS FROM SOASDHD WHERE SDHDDOCNO = '" & Set_Quote(cboDocNo.Text) & "'"
        rsSOASDHD.Open(wsSQL, cnCon, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockOptimistic)
        ...
        rsSOASDHD.Close()
        'UPGRADE_NOTE: Object rsSOASDHD may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        rsSOASDHD = Nothing
    ...
    Private Function cmdSave() As Boolean
        ...
        adcmdSave.CommandText = "USP_SDN001A"
        ...
        If waResult.get_UpperBound(1) >= 0 Then
            adcmdSave.CommandText = "USP_SDN001B"
            adcmdSave.CommandType = ADODB.CommandTypeEnum.adCmdStoredProc
            adcmdSave.Parameters.Refresh()
            ...
            For wiCtr = 0 To waResult.get_UpperBound(1)
                If Trim(waResult.get_Value(wiCtr, GQTY)) <> "" Then
                    ...
                    Call SetSPPara(adcmdSave, 17, waResult.get_Value(wiCtr, GDRMKID))
...
tblDetail_ButtonClick_Err:
    ...
    Private Sub cboCusCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboCusCode.DropDown
        ...
        Call Ini_Combo(2, wsSQL, VB6.PixelsToTwipsX(cboCusCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboCusCode.Top) + VB6.PixelsToTwipsY(cboCusCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "SDN001", "TBLCUSNO", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
...
RowColChange_Err:
    ...
    Private Function IsEmptyRow(Optional ByRef inRow As Object = Nothing) As Boolean
        ...
        Else
            If waResult.get_UpperBound(1) >= 0 Then
                If Trim(waResult.get_Value(inRow, GLINENO)) = "" And Trim(waResult.get_Value(inRow, GDESC1)) = "" And Trim(waResult.get_Value(inRow, GMORE)) = "" And Trim(waResult.get_Value(inRow, GDRMKID)) = "" And Trim(waResult.get_Value(inRow, GQTY)) = "" And Trim(waResult.get_Value(inRow, GPRICE)) = "" And Trim(waResult.get_Value(inRow, GDISPER)) = "" And Trim(waResult.get_Value(inRow, GMARKUP)) = "" And Trim(waResult.get_Value(inRow, GUOM)) = "" And Trim(waResult.get_Value(inRow, GAMT)) = "" And Trim(waResult.get_Value(inRow, GNET)) = "" Then
                    Exit Function
                End If
            End If
        End If
...
cmdDelete_Err:
    ...
    Private Sub OpenPromptForm()
        ...
        Me.Cursor = System.Windows.Forms.Cursors.WaitCursor
        With frmShareSearch
            wsSQL = "SELECT SOASDHD.SDHDDocNo, SOASDHD.SDHDDocDate, mstCustomer.CusCode,  mstCustomer.CusName "
            wsSQL = wsSQL & "FROM MstCustomer, SOASDHD "
            .sBindSQL = wsSQL
            .sBindWhereSQL = "WHERE SOASDHD.SDHDStatus = '1' And SOASDHD.SDHDCusID = MstCustomer.CusID "
            .sBindOrderSQL = "ORDER BY SOASDHD.SDHDDocNo"
        ...
        'UPGRADE_ISSUE: Form property frmSDN001.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
...
EventExitSub:
    ...
    Private Sub cboSaleCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboSaleCode.DropDown
        ...
        Call Ini_Combo(2, wsSQL, VB6.PixelsToTwipsX(cboSaleCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboSaleCode.Top) + VB6.PixelsToTwipsY(cboSaleCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "SDN001", "TBLSALECOD", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
...
EventExitSub:
    ...
    Private Sub cboPayCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboPayCode.DropDown
        ...
        Call Ini_Combo(2, wsSQL, VB6.PixelsToTwipsX(cboPayCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboPayCode.Top) + VB6.PixelsToTwipsY(cboPayCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "SDN001", "TBLPAYCOD", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
...
EventExitSub:
    ...
    Private Sub cboPrcCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboPrcCode.DropDown
        ...
        Call Ini_Combo(2, wsSQL, VB6.PixelsToTwipsX(cboPrcCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboPrcCode.Top) + VB6.PixelsToTwipsY(cboPrcCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "SDN001", "TBLPRCCOD", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
...
EventExitSub:
    ...
    Private Sub cboMLCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboMLCode.DropDown
        ...
        Call Ini_Combo(2, wsSQL, VB6.PixelsToTwipsX(cboMLCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboMLCode.Top) + VB6.PixelsToTwipsY(cboMLCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "SDN001", "TBLMLCOD", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
...
EventExitSub:
    ...
    Private Sub cboShipCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboShipCode.DropDown
        ...
        Call Ini_Combo(3, wsSQL, VB6.PixelsToTwipsX(cboShipCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboShipCode.Top) + VB6.PixelsToTwipsY(cboShipCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "SDN001", "TBLSHIPCOD", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
...
EventExitSub:
    ...
    Private Sub cboRmkCode_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboRmkCode.DropDown
        ...
        Call Ini_Combo(1, wsSQL, VB6.PixelsToTwipsX(cboRmkCode.Left) + VB6.PixelsToTwipsX(tabDetailInfo.Left), VB6.PixelsToTwipsY(cboRmkCode.Top) + VB6.PixelsToTwipsY(cboRmkCode.Height) + VB6.PixelsToTwipsY(tabDetailInfo.Top), tblCommon, "SDN001", "TBLRMKCOD", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
    ...
    Private Sub tblDetail_MouseUpEvent(ByVal eventSender As System.Object, ByVal eventArgs As AxTrueDBGrid60.TrueDBGridEvents_MouseUpEvent) Handles tblDetail.MouseUpEvent
        If eventArgs.Button = 2 Then
            'UPGRADE_ISSUE: Form method frmSDN001.PopupMenu was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
            'PopupMenu(mnuPopUp)
        End If
        ...
        If waResult.get_UpperBound(1) >= 0 Then
            ...
            For wiCtr = 0 To waResult.get_UpperBound(1)
                If Trim(waResult.get_Value(wiCtr, GDESC1)) <> "" Then
                    ...
                    waResult.get_Value(wiCtr, GNET) = VB6.Format(To_Value(waResult.get_Value(wiCtr, GAMT)) * To_Value(waResult.get_Value(wiCtr, GQTY)), gsAmtFmt)
    ...
    Private Sub cmdPrint()
        ...
        wsDteTim = CStr(Now)
        wsSQL = "EXEC usp_RPTSDN002 '" & Set_Quote(gsUserID) & "', "
        ...
        NewfrmPrint.ReportID = "SDN002"
        NewfrmPrint.RptTitle = Me.Text
        NewfrmPrint.TableID = "SDN002"
...
cmdRevise_Err:
    ...
    Private Function cmdCopyLine(ByVal CRow As Integer) As Integer
        ...
        With waResult
            ...
            Else
                waResult.get_Value(.get_UpperBound(1), GDRMKID) = Get_DRmkID("DT", waResult.get_Value(CRow, GDRMKID))
            End If
...
cmdCopyLine_Err:
    ...
    Private Function Get_RefDoc() As Boolean
        ...
        wsSQL = "SELECT SOHDDOCID, SOHDDOCNO, SOHDCUSID, CUSID, CUSCODE, CUSNAME, CUSTEL, CUSFAX, CUSFAX, "
        ...
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtDisAmt.Text = VB6.Format(ReadRs(rsRcd, "SOHDDISAMT"), gsAmtFmt)
