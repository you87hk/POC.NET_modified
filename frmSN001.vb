...
EventExitSub:
    ...
    Private Sub cboDocNo_DropDown(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cboDocNo.DropDown
        ...
        wsSQL = wsSQL & " AND SNHDCTLPRD  BETWEEN '" & Str(Val(VB.Left(gsSystemDate, 4)) - 1) & "01" & "' AND '" & VB.Left(gsSystemDate, 4) & "12" & "'"
...
EventExitSub:
    ...
    Private Sub frmSN001_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub frmSN001_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmSN001_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
    ...
    Private Function LoadRecord() As Boolean
        ...
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        lblDspRevNo.Text = VB6.Format(ReadRs(rsInvoice, "SNHDREVNO"), "##0")
        ...
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtExcr.Text = VB6.Format(ReadRs(rsInvoice, "SNHDEXCR"), gsExrFmt)
        ...
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        txtSpecDis.Text = VB6.Format(ReadRs(rsInvoice, "SNHDSPECDIS"), gsAmtFmt)
        ...
        For i = 1 To 10
            ...
            'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            txtRmk(i).Text = ReadRs(rsInvoice, "SNHDRMK" & i)
        Next i
        ...
        lblDspGrsAmtOrg.Text = VB6.Format(To_Value(ReadRs(rsInvoice, "SNHDGRSAMT")), gsAmtFmt)
        lblDspDisAmtOrg.Text = VB6.Format(To_Value(ReadRs(rsInvoice, "SNHDDISAMT")), gsAmtFmt)
        lblDspNetAmtOrg.Text = VB6.Format(To_Value(ReadRs(rsInvoice, "SNHDNETAMT")), gsAmtFmt)
        lblDspCstAmtOrg.Text = VB6.Format(To_Value(ReadRs(rsInvoice, "SNHDCSTAMT")), gsAmtFmt)

        txtDisAmt.Text = VB6.Format(To_Value(ReadRs(rsInvoice, "SNHDDISAMT")), gsAmtFmt)
...
Ini_Caption_Err:
    ...
    Private Sub frmSN001_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseUp
    ...
    Private Sub frmSN001_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
    ...
    Private Sub frmSN001_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
...
tblCommon_LostFocus_Err:
    ...
    Private Function Chk_KeyExist() As Boolean
        ...
        Dim rsSOASNHD As New ADODB.Recordset
        Dim wsSQL As String
        ...
        If rsSOASNHD.RecordCount > 0 Then
        ...
        If waResult.get_UpperBound(1) >= 0 Then
            ...
            For wiCtr = 0 To waResult.get_UpperBound(1)
                If Trim(waResult.get_Value(wiCtr, GQTY)) <> "" Then
                    ...
                    Call SetSPPara(adcmdSave, 21, IIf(waResult.get_Value(wiCtr, GPRINT) = "-1", "Y", "N"))
