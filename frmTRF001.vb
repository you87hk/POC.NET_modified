...
Friend Class frmTRF001
	...
	Private Const UpdFlg As Short = 11
	Private Const ITMID As Short = 12
	Private Const SOID As Short = 13
	...
	Private Sub btnITMLST_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnITMLST.Click
		If wiAction <> AddRec And wiAction <> CorRec Then Exit Sub
		
		frmITMLST.InvDoc = waResult
		frmITMLST.inLineNo = wlLineNo
		frmITMLST.ShowDialog()
		waResult.ReDim(0, frmITMLST.InvDoc.UpperBound(1), LINENO, SOID)
		waResult = frmITMLST.InvDoc
		wlLineNo = frmITMLST.inLineNo
		frmITMLST.Close()
		tblDetail.ReBind()
		tblDetail.Bookmark = 0
...
EventExitSub: 
	...
	'UPGRADE_WARNING: Form event frmTRF001.Activate has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6BA9B8D2-2A32-4B6E-8D36-44949974A5B4"'
	Private Sub frmTRF001_Activated(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Activated
	...
	Private Sub frmTRF001_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmTRF001_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	Private Function LoadRecord() As Boolean
		...
		Dim wdSOHqty As Double
		Dim wsLotTo As String
		
		
		LoadRecord = False
		
		wsSQL = "SELECT DISTINCT SJDTWHSCODE, SJDTTRNTYPE  "
		...
		Do While Not rsInvoice.EOF
			'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(rsInvoice, SJDTTRNTYPE). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			If ReadRs(rsInvoice, "SJDTTRNTYPE") = "STKIN" Then
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				cboWhsCodeTo.Text = ReadRs(rsInvoice, "SJDTWHSCODE")
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(rsInvoice, SJDTTRNTYPE). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			ElseIf ReadRs(rsInvoice, "SJDTTRNTYPE") = "STKOUT" Then 
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		...
		wsSQL = "SELECT SJHDDOCID, SJHDDOCNO, SJHDDOCDATE, SJDTDOCLINE, SJHDSTAFFID, SJHDJOBNO, "
		wsSQL = wsSQL & "SJDTITEMID, ITMCODE, ITMITMTYPECODE, SJDTWHSCODE, SJDTLOTNO, "
		...
		wsSQL = wsSQL & "SJHDREMARK, SJHDREMARK2, SJHDREMARK3, SJDTUPDFLG "
		...
		wsSQL = wsSQL & "AND SJHDTRNCODE  = '" & wsTrnCd & "' "
		wsSQL = wsSQL & "AND SJDTTRNTYPE = 'STKOUT'"
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		cboJobNo.Text = ReadRs(rsInvoice, "SJHDJOBNO")
		
		lblDspWhsFr.Text = Get_TableInfo("MstWarehouse", "WhsCode ='" & cboWhsCodeFr.Text & "'", "WHSDESC")
		lblDspWhsTo.Text = Get_TableInfo("MstWarehouse", "WhsCode ='" & cboWhsCodeTo.Text & "'", "WHSDESC")
		...
		With waResult
			...
			Do While Not rsInvoice.EOF
				...
				'            wdSOHqty = Get_StockAvailable(ReadRs(rsInvoice, "SJDTITEMID"), cboWhsCodeFr.Text, "")
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(rsInvoice, SJDTLOTNO). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				wdSOHqty = Get_IcTrnQty("INOUT", ReadRs(rsInvoice, "SJDTITEMID"), cboWhsCodeFr.Text, ReadRs(rsInvoice, "SJDTLOTNO"))
				
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(rsInvoice, SJDTITEMID). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				wsLotTo = Get_TransferLotTo(ReadRs(rsInvoice, "SJHDDOCID"), ReadRs(rsInvoice, "SJDTITEMID"))
				
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(rsInvoice, SJDTUPDFLG). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				If ReadRs(rsInvoice, "SJDTUPDFLG") = "Y" Then
					wbReadOnly = True
				End If
				...
				waResult.get_Value(.get_UpperBound(1), LOTTO) = wsLotTo
				waResult.get_Value(.get_UpperBound(1), SOH) = VB6.Format(wdSOHqty, gsQtyFmt)
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), QTY) = VB6.Format(ReadRs(rsInvoice, "SJDTQTY"), gsQtyFmt)
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), PRICE) = VB6.Format(ReadRs(rsInvoice, "SJDTUPRICE"), gsUprFmt)
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), NET) = VB6.Format(ReadRs(rsInvoice, "SJDTAMT"), gsAmtFmt)
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), ITMID) = ReadRs(rsInvoice, "SJDTITEMID")
				'UPGRADE_WARNING: Couldn't resolve default property of object ReadRs(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				waResult.get_Value(.get_UpperBound(1), UpdFlg) = ReadRs(rsInvoice, "SJDTUPDFLG")
				rsInvoice.MoveNext()
			Loop 
	...
	Private Sub Ini_Caption()
		...
		With tblDetail
			...
			.Columns(LOTTO).Caption = Get_Caption(waScrItm, "LOTTO")
		...
		wsActNam(1) = Get_Caption(waScrItm, "TRFADD")
		wsActNam(2) = Get_Caption(waScrItm, "TRFEDIT")
		wsActNam(3) = Get_Caption(waScrItm, "TRFDELETE")
		
		wgsTitle = Get_Caption(waScrItm, "TITLE")
		wgsTRTitle = Get_Caption(waScrItm, "TRTITLE")
		
		btnITMLST.Text = Get_Caption(waScrItm, "ITMLST")
...
Ini_Caption_Err: 
	...
	Private Sub frmTRF001_MouseUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseUp
	...
	'UPGRADE_WARNING: Event frmTRF001.Resize may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
	Private Sub frmTRF001_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
	...
	Private Sub frmTRF001_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        ...
        'UPGRADE_NOTE: Object frmTRF001 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        Me.Close() ' = Nothing
...
tblCommon_LostFocus_Err:
    ...
    Private Function cmdSave() As Boolean
        ...
        adcmdSave.CommandText = "USP_TRF001A"
        ...
        Call SetSPPara(adcmdSave, 6, txtRmk)
        Call SetSPPara(adcmdSave, 7, txtRmk2)
        Call SetSPPara(adcmdSave, 8, txtRmk3)

        Call SetSPPara(adcmdSave, 9, wsCtlPrd)
        Call SetSPPara(adcmdSave, 10, wlSaleID)

        Call SetSPPara(adcmdSave, 11, cboJobNo.Text)
        Call SetSPPara(adcmdSave, 12, wsSrcCode)
        ...
        If waResult.get_UpperBound(1) >= 0 Then
            adcmdSave.CommandText = "USP_TRF001B"
            adcmdSave.CommandType = ADODB.CommandTypeEnum.adCmdStoredProc
            adcmdSave.Parameters.Refresh()
            ...
            For wiCtr = 0 To waResult.get_UpperBound(1)
                If Trim(waResult.get_Value(wiCtr, ITMCODE)) <> "" Then
                    ...
                    Call SetSPPara(adcmdSave, 5, waResult.get_Value(wiCtr, QTY) * -1)
                    ...
                    Call SetSPPara(adcmdSave, 10, waResult.get_Value(wiCtr, NET) * -1)
                    Call SetSPPara(adcmdSave, 11, waResult.get_Value(wiCtr, NET))
                    Call SetSPPara(adcmdSave, 12, "STKOUT")
                    Call SetSPPara(adcmdSave, 13, IIf(wlRowCtr = wiCtr, "Y", "N"))
                    Call SetSPPara(adcmdSave, 14, waResult.get_Value(wiCtr, UpdFlg))
            ...
            For wiCtr = 0 To waResult.get_UpperBound(1)
                If Trim(waResult.get_Value(wiCtr, ITMCODE)) <> "" Then
                    ...
                    Call SetSPPara(adcmdSave, 6, waResult.get_Value(wiCtr, QTY))
                    Call SetSPPara(adcmdSave, 7, cboWhsCodeTo)
                    Call SetSPPara(adcmdSave, 8, waResult.get_Value(wiCtr, LOTTO))
                    Call SetSPPara(adcmdSave, 9, waResult.get_Value(wiCtr, PRICE))
                    Call SetSPPara(adcmdSave, 10, waResult.get_Value(wiCtr, NET))
                    Call SetSPPara(adcmdSave, 11, waResult.get_Value(wiCtr, NET))
                    Call SetSPPara(adcmdSave, 12, "STKIN")
                    Call SetSPPara(adcmdSave, 13, IIf(wlRowCtr = wiCtr, "Y", "N"))
                    Call SetSPPara(adcmdSave, 14, waResult.get_Value(wiCtr, UpdFlg))
                    Call SetSPPara(adcmdSave, 15, gsUserID)
                    Call SetSPPara(adcmdSave, 16, wsGenDte)
...
cmdSave_Err:
    ...
    Private Function InputValidation() As Boolean
        ...
        If Not chk_cboWhsCodeTo Then Exit Function
        ...
        With tblDetail
            Select Case eventArgs.ColIndex
                Case ITMTYPE
                    ...
                    If Trim(.Columns(UpdFlg).Text) = "Y" Then
                        gsMsg = "Transfer line updated Cannot Edit!"
                        MsgBox(gsMsg, MsgBoxStyle.OKOnly, gsTitle)
                        GoTo Tbl_BeforeColUpdate_Err
                    End If
                ...
                Case ITMCODE
                    ...
                    If Chk_grdITMCODE((.Columns(eventArgs.ColIndex).Text), (.Columns(ITMTYPE).Text), wsITMID, wsITMCODE, "", wsITMNAME, wsPub, wdPrice, wdDisPer, wsWhsCode, wsLotNo, wdQty) = False Then
                        GoTo Tbl_BeforeColUpdate_Err
                    End If

                    'wdSOHqty = Get_StockAvailable(wsITMID, cboWhsCodeFr.Text, "")

                    wdSOHqty = Get_IcTrnQty("INOUT", CInt(wsITMID), cboWhsCodeFr.Text, "")


                    .Columns(LINENO).Text = CStr(wlLineNo)
                    .Columns(ITMID).Text = wsITMID
                    ' .Columns(LOTTO).Text = wsLOTTO
                    .Columns(ITMNAME).Text = wsITMNAME
                    .Columns(SOH).Text = VB6.Format(wdSOHqty, gsQtyFmt)
                ...
                Case LOTNO
                    ...
                    If Chk_grdLotNo((cboWhsCodeFr.Text), (.Columns(eventArgs.ColIndex).Text)) = False Then
                        GoTo Tbl_BeforeColUpdate_Err
                    End If

                    If Chk_LotEnabled(cboWhsCodeFr.Text) = True Then
                        .Columns(SOH).Text = CStr(Get_IcTrnQty("INOUT", CInt(.Columns(ITMID).Text), cboWhsCodeFr.Text, .Columns(eventArgs.ColIndex).Text))
                    End If
                ...
                Case LOTTO
                    ...
                    If Chk_grdLotNo((cboWhsCodeTo.Text), (.Columns(eventArgs.ColIndex).Text)) = False Then
                        GoTo Tbl_BeforeColUpdate_Err
                    End If


                    '  If Chk_LotEnabled(cboWhsCodeTo.Text) = True Then
                    '       .Columns(SOH).Text = Get_IcTrnQty("INOUT", .Columns(ITMID).Text, cboWhsCodeTo.Text, .Columns(ColIndex).Text)
                    '  End If
                ...
                Case QTY
                    ...
                    If eventArgs.ColIndex = QTY Then
                        If Chk_grdQty((.Columns(eventArgs.ColIndex).Text)) = False Then
                            GoTo Tbl_BeforeColUpdate_Err
                        Else
                            .Columns(NET).Text = VB6.Format(To_Value((.Columns(PRICE).Text)) * To_Value((.Columns(QTY).Text)), gsAmtFmt)
                        End If
                    End If
		...
		With tblDetail
			Select Case eventArgs.ColIndex
				...
				Case LOTNO
					...
					Call Ini_Combo(2, wsSQL, .Columns(eventArgs.ColIndex).Left + VB6.PixelsToTwipsX(.Left) + .Columns(eventArgs.ColIndex).Top, VB6.PixelsToTwipsY(.Top) + .RowTop(.Row) + .RowHeight, tblCommon, wsFormID, "TBLLOCCODE", VB6.PixelsToTwipsX(Me.Width), VB6.PixelsToTwipsY(Me.Height))
					tblCommon.Visible = True
					tblCommon.Focus()
					wcCombo = tblDetail
				...
				Case LOTTO
					...
					wsSQL = "SELECT ILLOCCODE, ILSOHQTY "
					wsSQL = wsSQL & " FROM ICLOCBAL, MSTITEM "
					wsSQL = wsSQL & " WHERE ILLOCCODE LIKE '%" & Set_Quote(.Columns(LOTTO).Text) & "%' "
					wsSQL = wsSQL & " AND ILITEMID = ITMID "
					wsSQL = wsSQL & " AND ITMCODE = '" & Set_Quote(.Columns(ITMCODE).Text) & "'"
					wsSQL = wsSQL & " AND ILWHSCODE = '" & cboWhsCodeTo.Text & "'"
		...
		With tblDetail
			Select Case eventArgs.KeyCode
				...
				Case System.Windows.Forms.Keys.F8 ' DELETE LINE
					...
					If Chk_TrfUpd(.Bookmark) = True Then Exit Sub
					gsMsg = "你是否確定要刪除此列?"
		...
		With tblDetail
			...
			If Trim(.Columns(.Col).Text) <> "" Then
				Select Case .Col
					...
					Case LOTNO
						Call Chk_grdLotNo((cboWhsCodeFr.Text), (.Columns(LOTNO).Text))
					Case LOTTO
						Call Chk_grdLotNo((cboWhsCodeTo.Text), (.Columns(LOTTO).Text))
...
RowColChange_Err: 
	...
	Private Function Chk_grdITMCODE(ByRef inAccNo As String, ByRef inItmType As String, ByRef outAccID As String, ByRef outAccNo As String, ByRef OutLOTTO As String, ByRef OutName As String, ByRef outPub As String, ByRef outPrice As Double, ByRef outDisPer As Double, ByRef outWhsCode As String, ByRef outLotNo As String, ByRef outQty As Double) As Boolean
		...
		wsSQL = "SELECT ITMID, ITMCODE, " & IIf(gsLangID = "1", "ITMENGNAME", "ITMCHINAME") & " ITMNAME, ITMUNITPRICE "
		wsSQL = wsSQL & " FROM mstITEM "
		...
		Else
			...
			outLotNo = ""
			outQty = CDbl(VB6.Format(0, gsAmtFmt))
			outPrice = CDbl(VB6.Format(0, gsUprFmt))
			gsMsg = "沒有此物料!"
			MsgBox(gsMsg, MsgBoxStyle.OKOnly, gsTitle)
			Chk_grdITMCODE = False
		End If
	...
	Private Function Chk_GrdRow(ByVal LastRow As Integer) As Boolean
		...
		With tblDetail
			...
			If Chk_grdLotNo((cboWhsCodeFr.Text), waResult.get_Value(LastRow, LOTNO)) = False Then
				.Col = LOTNO
				.Row = LastRow
				Exit Function
			End If
			
			If Chk_grdLotNo((cboWhsCodeTo.Text), waResult.get_Value(LastRow, LOTTO)) = False Then
				.Col = LOTTO
				.Row = LastRow
				Exit Function
			End If
...
cmdDelete_Err: 
	...
	Private Sub OpenPromptForm()
		...
		'UPGRADE_ISSUE: Form property frmTRF001.MousePointer does not support custom mousepointers. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="45116EAB-7060-405E-8ABE-9DBB40DC2E86"'
	...
	Private Sub tblDetail_MouseUpEvent(ByVal eventSender As System.Object, ByVal eventArgs As AxTrueDBGrid60.TrueDBGridEvents_MouseUpEvent) Handles tblDetail.MouseUpEvent
		If eventArgs.Button = 2 Then
			'UPGRADE_ISSUE: Form method frmTRF001.PopupMenu was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
            'PopupMenu(mnuPopUp)
		End If
	...
	Private Sub cmdPrint()
		...
		wsDteTim = CStr(Now)
		wsSQL = "EXEC usp_RPTTRF002 '" & Set_Quote(gsUserID) & "', "
		...
		If gsLangID = "2" Then
			wsRptName = "C" & "RPTTRF002"
		Else
			wsRptName = "RPTTRF002"
		End If
		
		NewfrmPrint.ReportID = "TRF002"
		NewfrmPrint.RptTitle = Me.Text
		NewfrmPrint.TableID = "TRF002"
	...
	Private Function Calc_Total(Optional ByVal LastRow As Object = Nothing) As Boolean
		...
		For wiRowCtr = 0 To waResult.get_UpperBound(1)
			...
			wdTotalPrice = wdTotalPrice + To_Value(waResult.get_Value(wiRowCtr, NET))
		Next 
		
		lblDspTrnAmt.Text = VB6.Format(CStr(wdTotalPrice), gsAmtFmt)
	...
	Private Function Chk_cboWhsCodeFr() As Boolean
		...
		If Chk_WhsCode(cboWhsCodeFr.Text, wsStatus, wsDesc) = False Then
			gsMsg = "倉庫不存在!"
			MsgBox(gsMsg, MsgBoxStyle.Information + MsgBoxStyle.OKOnly, gsTitle)
			lblDspWhsFr.Text = ""
			cboWhsCodeFr.Focus()
	...
	Private Function chk_cboWhsCodeTo() As Boolean
		...
		If Trim(cboWhsCodeTo.Text) = "" Then
			gsMsg = "沒有輸入目的倉庫!"
			MsgBox(gsMsg, MsgBoxStyle.Information + MsgBoxStyle.OKOnly, gsTitle)
			cboWhsCodeTo.Focus()
			Exit Function
		...
		'  If Trim(cboWhsCodeFr.Text) = Trim(cboWhsCodeTo.Text) Then
		'      gsMsg = "來源與目的倉庫不可相同!"
		...
		If Chk_WhsCode(cboWhsCodeTo.Text, wsStatus, wsDesc) = False Then
			gsMsg = "倉庫不存在!"
			MsgBox(gsMsg, MsgBoxStyle.Information + MsgBoxStyle.OKOnly, gsTitle)
			lblDspWhsTo.Text = ""
			cboWhsCodeTo.Focus()
		...
		lblDspWhsTo.Text = wsDesc
		
		chk_cboWhsCodeTo = True
	End Function
	
	Private Function Chk_WhsCode(ByVal inCode As String, ByRef outCode As String, ByRef OutName As String) As Boolean
		Dim rsRcd As New ADODB.Recordset
		Dim wsSQL As String
		...
		wsSQL = "SELECT WhsStatus, WhsDesc "
...
EventExitSub: 
	...
	Private Function Chk_TrfUpd(ByVal CRow As Integer) As Boolean
		Dim wsSQL As String
		Dim wsUpdFlg As String
		
		On Error GoTo Chk_TrfUpd_Err
		...
		wsUpdFlg = waResult.get_Value(CRow, UpdFlg)
		
		
		If wsUpdFlg = "Y" Then
			gsMsg = "Line updated ! Cannot Delete/Edit"
			MsgBox(gsMsg, MsgBoxStyle.OKOnly, gsTitle)
			Chk_TrfUpd = True
			Exit Function
		End If
